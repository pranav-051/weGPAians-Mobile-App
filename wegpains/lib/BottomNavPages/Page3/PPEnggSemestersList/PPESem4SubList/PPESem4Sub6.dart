...
class PPESem4Sub6 extends StatefulWidget {
  const PPESem4Sub6({key, required this.title});
  final String title;
  @override
  State<PPESem4Sub6> createState() => _PPESem4Sub6();
}

class _PPESem4Sub6 extends State<PPESem4Sub6> {
  bool semester = false;
  @override
