...
class PPESem1Sub6 extends StatefulWidget {
  const PPESem1Sub6({key, required this.title});
  final String title;
  @override
  State<PPESem1Sub6> createState() => _PPESem1Sub6();
}

class _PPESem1Sub6 extends State<PPESem1Sub6> {
  bool semester = false;
  @override
