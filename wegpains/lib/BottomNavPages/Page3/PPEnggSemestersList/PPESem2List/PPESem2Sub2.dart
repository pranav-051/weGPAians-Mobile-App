...
class PPESem2Sub2 extends StatefulWidget {
  const PPESem2Sub2({key, required this.title});
  final String title;
  @override
  State<PPESem2Sub2> createState() => _PPESem2Sub2();
}

class _PPESem2Sub2 extends State<PPESem2Sub2> {
  bool semester = false;
  @override
