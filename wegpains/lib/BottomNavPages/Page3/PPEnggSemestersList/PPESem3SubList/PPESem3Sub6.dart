...
class PPESem3Sub6 extends StatefulWidget {
  const PPESem3Sub6({key, required this.title});
  final String title;
  @override
  State<PPESem3Sub6> createState() => _PPESem3Sub6();
}

class _PPESem3Sub6 extends State<PPESem3Sub6> {
  bool semester = false;
  @override
