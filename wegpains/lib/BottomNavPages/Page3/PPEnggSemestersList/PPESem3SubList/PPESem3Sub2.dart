...
class PPESem3Sub2 extends StatefulWidget {
  const PPESem3Sub2({key, required this.title});
  final String title;
  @override
  State<PPESem3Sub2> createState() => _PPESem3Sub2();
}

class _PPESem3Sub2 extends State<PPESem3Sub2> {
  bool semester = false;
  @override
