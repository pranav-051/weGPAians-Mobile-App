...
class PPESem6Sub1 extends StatefulWidget {
  const PPESem6Sub1({key, required this.title});
  final String title;
  @override
  State<PPESem6Sub1> createState() => _PPESem6Sub1();
}

class _PPESem6Sub1 extends State<PPESem6Sub1> {
  bool semester = false;
  @override
