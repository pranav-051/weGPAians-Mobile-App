...
class PPESem6Sub6 extends StatefulWidget {
  const PPESem6Sub6({key, required this.title});
  final String title;
  @override
  State<PPESem6Sub6> createState() => _PPESem6Sub6();
}

class _PPESem6Sub6 extends State<PPESem6Sub6> {
  bool semester = false;
  @override
