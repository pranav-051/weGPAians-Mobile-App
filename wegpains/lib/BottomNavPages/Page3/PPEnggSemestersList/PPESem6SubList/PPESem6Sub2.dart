...
class PPESem6Sub2 extends StatefulWidget {
  const PPESem6Sub2({key, required this.title});
  final String title;
  @override
  State<PPESem6Sub2> createState() => _PPESem6Sub2();
}

class _PPESem6Sub2 extends State<PPESem6Sub2> {
  bool semester = false;
  @override
