...
class ChemSem4Sub1 extends StatefulWidget {
  const ChemSem4Sub1({key, required this.title});
  final String title;
  @override
  State<ChemSem4Sub1> createState() => _ChemSem4Sub1();
}

class _ChemSem4Sub1 extends State<ChemSem4Sub1> {
  bool semester = false;
  @override
