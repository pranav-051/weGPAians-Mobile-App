...
class ChemSem4Sub6 extends StatefulWidget {
  const ChemSem4Sub6({key, required this.title});
  final String title;
  @override
  State<ChemSem4Sub6> createState() => _ChemSem4Sub6();
}

class _ChemSem4Sub6 extends State<ChemSem4Sub6> {
  bool semester = false;
  @override
