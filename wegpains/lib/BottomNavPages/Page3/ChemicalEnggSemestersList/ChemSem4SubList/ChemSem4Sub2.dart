...
class ChemSem4Sub2 extends StatefulWidget {
  const ChemSem4Sub2({key, required this.title});
  final String title;
  @override
  State<ChemSem4Sub2> createState() => _ChemSem4Sub2();
}

class _ChemSem4Sub2 extends State<ChemSem4Sub2> {
  bool semester = false;
  @override
