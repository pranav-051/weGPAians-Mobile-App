...
class ChemSem1Sub4 extends StatefulWidget {
  const ChemSem1Sub4({key, required this.title});
  final String title;
  @override
  State<ChemSem1Sub4> createState() => _ChemSem1Sub4();
}

class _ChemSem1Sub4 extends State<ChemSem1Sub4> {
  bool semester = false;
  @override
