...
class ChemSem1Sub6 extends StatefulWidget {
  const ChemSem1Sub6({key, required this.title});
  final String title;
  @override
  State<ChemSem1Sub6> createState() => _ChemSem1Sub6();
}

class _ChemSem1Sub6 extends State<ChemSem1Sub6> {
  bool semester = false;
  @override
