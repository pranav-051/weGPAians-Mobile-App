...
class ChemSem1Sub1 extends StatefulWidget {
  const ChemSem1Sub1({key, required this.title});
  final String title;
  @override
  State<ChemSem1Sub1> createState() => _ChemSem1Sub1();
}

class _ChemSem1Sub1 extends State<ChemSem1Sub1> {
  bool semester = false;
  @override
