...
class ChemSem2Sub2 extends StatefulWidget {
  const ChemSem2Sub2({key, required this.title});
  final String title;
  @override
  State<ChemSem2Sub2> createState() => _ChemSem2Sub2();
}

class _ChemSem2Sub2 extends State<ChemSem2Sub2> {
  bool semester = false;
  @override
