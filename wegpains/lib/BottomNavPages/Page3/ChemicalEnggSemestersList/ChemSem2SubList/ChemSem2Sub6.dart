...
class ChemSem2Sub6 extends StatefulWidget {
  const ChemSem2Sub6({key, required this.title});
  final String title;
  @override
  State<ChemSem2Sub6> createState() => _ChemSem2Sub6();
}

class _ChemSem2Sub6 extends State<ChemSem2Sub6> {
  bool semester = false;
  @override
