...
class ChemSem2Sub1 extends StatefulWidget {
  const ChemSem2Sub1({key, required this.title});
  final String title;
  @override
  State<ChemSem2Sub1> createState() => _ChemSem2Sub1();
}

class _ChemSem2Sub1 extends State<ChemSem2Sub1> {
  bool semester = false;
  @override
