...
class ChemSem5Sub1 extends StatefulWidget {
  const ChemSem5Sub1({key, required this.title});
  final String title;
  @override
  State<ChemSem5Sub1> createState() => _ChemSem5Sub1();
}

class _ChemSem5Sub1 extends State<ChemSem5Sub1> {
  bool semester = false;
  @override
