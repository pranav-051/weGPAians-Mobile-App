...
class ChemSem6Sub1 extends StatefulWidget {
  const ChemSem6Sub1({key, required this.title});
  final String title;
  @override
  State<ChemSem6Sub1> createState() => _ChemSem6Sub1();
}

class _ChemSem6Sub1 extends State<ChemSem6Sub1> {
  bool semester = false;
  @override
