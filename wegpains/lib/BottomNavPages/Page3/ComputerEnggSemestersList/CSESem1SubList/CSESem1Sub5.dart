...
import 'CSESem1Sub5/CSESem1Sub5Curr.dart';
import 'CSESem1Sub5/CSESem1Sub5QTPaper.dart';
import 'CSESem1Sub5/CSESem1Sub5QTPaperFormat.dart';
import 'CSESem1Sub5/CSESem1Sub5Utube.dart';
import 'CSESem1Sub5/CSESem1Sub5ebooks.dart';

class CSESem1Sub5 extends StatefulWidget {
  const CSESem1Sub5 ({Key? key, required this.title}) : super(key: key);
  final String title;
  @override
  State<CSESem1Sub5> createState() => _CSESem1Sub5();
}

class _CSESem1Sub5 extends State<CSESem1Sub5> {
  bool semester = false;
  @override
    ...
    return Scaffold(
        ...
        body: ListView(
          ...
          children: <Widget>[
                ...
                child: Card(
                    ...
                    child: InkWell(
                        onLongPress: () => {
                          Navigator.push(
                            context,
                            MaterialPageRoute(builder: (context) =>  const CSESem1Sub5Curr()),
                          )
                        },
                        child: Container(
                ...
                child: Card(
                    ...
                    child: InkWell(
                        onLongPress: () => {
                          Navigator.push(
                            context,
                            MaterialPageRoute(builder: (context) =>  const CSESem1Sub5ebooks()),
                          )
                        },
                        child: Container(
                            decoration: const BoxDecoration(
                    ...
                    child: InkWell(
                        onLongPress: () => {
                          Navigator.push(
                            ...
                            MaterialPageRoute(
                                builder: (context) =>
                                const CSESem1Sub5Utube(title: 'web',)),
                          )
                        },
                        child: Container(
                            decoration: const BoxDecoration(
            ...
            //               Navigator.push(
            //                 context,
            //                 MaterialPageRoute(builder: (context) =>  const CSESem1Sub5QTPaper()),
            //               )
            //             },
            //             child: Container(
            //                 decoration: const BoxDecoration(
            ...
            //               Navigator.push(
            //                 context,
            //                 MaterialPageRoute(builder: (context) =>  const CSESem1Sub5QTPaperFormat()),
            //               )
            //             },
            //             child: Container(
            //                 decoration: const BoxDecoration(
