...
class CSESem1Sub6QTPaper extends StatefulWidget{
  const CSESem1Sub6QTPaper({Key?key}) : super(key : key);
  @override
  _CSESem1Sub6QTPaper createState() => _CSESem1Sub6QTPaper();
}

class _CSESem1Sub6QTPaper extends State<CSESem1Sub6QTPaper>{
  //++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
  ...
  uploadDataToFirebase() async{
    ...
    //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    var CSESem1Sub6QTPaper = pick.readAsBytesSync();
    //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    ...
    //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    UploadTask task = pdffile.putData(CSESem1Sub6QTPaper);
    //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    ...
    //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    await FirebaseFirestore.instance.collection("CSESem1Sub6QTPaper").doc().set({
      //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++

      'fileUrl': url,
      'num': "question paper #$number"
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        iconTheme: const IconThemeData(
            color: Colors.white),
        title: const Text("Engineering Graphics", style: TextStyle(color: Colors.white),),
      ),
      body: StreamBuilder(

        //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
        stream: FirebaseFirestore.instance.collection("CSESem1Sub6QTPaper").snapshots(),
        //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
