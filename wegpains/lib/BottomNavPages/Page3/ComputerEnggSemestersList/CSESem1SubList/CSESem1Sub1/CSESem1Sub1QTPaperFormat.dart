...
class CSESem1Sub1QTPaperFormat extends StatefulWidget{
  const CSESem1Sub1QTPaperFormat({Key?key}) : super(key : key);
  @override
  _CSESem1Sub1QTPaperFormat createState() => _CSESem1Sub1QTPaperFormat();
}

class _CSESem1Sub1QTPaperFormat extends State<CSESem1Sub1QTPaperFormat>{
  //++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
  ...
  uploadDataToFirebase() async{
    ...
    //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    var CSESem1Sub1QTPaperFormat = pick.readAsBytesSync();
    //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    ...
    //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    UploadTask task = pdffile.putData(CSESem1Sub1QTPaperFormat);
    //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    ...
    //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    await FirebaseFirestore.instance.collection("CSESem1Sub1QTPaperFormat").doc().set({
      //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
  ...
  Widget build (BuildContext context) {
    return Scaffold(
      ...
      body: StreamBuilder(
        ...
        //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
        stream: FirebaseFirestore.instance.collection("CSESem1Sub1QTPaperFormat").snapshots(),
        //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
