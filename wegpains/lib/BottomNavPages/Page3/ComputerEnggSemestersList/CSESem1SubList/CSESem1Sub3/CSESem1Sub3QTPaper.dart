...
class CSESem1Sub3QTPaper extends StatefulWidget{
  const CSESem1Sub3QTPaper({Key?key}) : super(key : key);
  @override
  _CSESem1Sub3QTPaper createState() => _CSESem1Sub3QTPaper();
}

class _CSESem1Sub3QTPaper extends State<CSESem1Sub3QTPaper>{
  //++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
  ...
  uploadDataToFirebase() async{
    ...
    //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    var CSESem1Sub3QTPaper = pick.readAsBytesSync();
    //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    ...
    //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    UploadTask task = pdffile.putData(CSESem1Sub3QTPaper);
    //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    ...
    //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    await FirebaseFirestore.instance.collection("CSESem1Sub3QTPaper").doc().set({
      //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++

      'fileUrl': url,
      'num': "Sample Question Papers#$number"
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        iconTheme: const IconThemeData(
            color: Colors.white),
        title: const Text("Sample Question Papers", style: TextStyle(color: Colors.white),),
      ),
      body: StreamBuilder(

        //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
        stream: FirebaseFirestore.instance.collection("CSESem1Sub3QTPaper").snapshots(),
        //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
