...
class CSESem3Sub3QTPaperFormat extends StatefulWidget{
  const CSESem3Sub3QTPaperFormat({Key?key}) : super(key : key);
  @override
  _CSESem3Sub3QTPaperFormat createState() => _CSESem3Sub3QTPaperFormat();
}

class _CSESem3Sub3QTPaperFormat extends State<CSESem3Sub3QTPaperFormat>{
  //++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
  ...
  uploadDataToFirebase() async{
    ...
    //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    var CSESem3Sub3QTPaperFormat = pick.readAsBytesSync();
    //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    ...
    //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    UploadTask task = pdffile.putData(CSESem3Sub3QTPaperFormat);
    //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    ...
    //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    await FirebaseFirestore.instance.collection("CSESem3Sub3QTPaperFormat").doc().set({
      //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
  ...
  Widget build (BuildContext context) {
    return Scaffold(
      ...
      body: StreamBuilder(
        ...
        //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
        stream: FirebaseFirestore.instance.collection("CSESem3Sub3QTPaperFormat").snapshots(),
        //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
