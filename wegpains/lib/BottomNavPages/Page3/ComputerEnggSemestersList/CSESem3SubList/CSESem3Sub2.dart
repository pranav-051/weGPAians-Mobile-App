...
import 'CSESem3Sub2/CSESem3Sub2Curr.dart';
import 'CSESem3Sub2/CSESem3Sub2MP.dart';
import 'CSESem3Sub2/CSESem3Sub2QTPaper.dart';
import 'CSESem3Sub2/CSESem3Sub2QTPaperFormat.dart';
import 'CSESem3Sub2/CSESem3Sub2SPrac.dart';
import 'CSESem3Sub2/CSESem3Sub2Utube.dart';
import 'CSESem3Sub2/CSESem3Sub2ebooks.dart';

class CSESem3Sub2 extends StatefulWidget {
  const CSESem3Sub2 ({Key? key, required this.title}) : super(key: key);
  final String title;
  @override
  State<CSESem3Sub2> createState() => _CSESem3Sub2();
}

class _CSESem3Sub2 extends State<CSESem3Sub2> {
  bool semester = false;
  @override
                ...
                child: Card(
                    ...
                    child: InkWell(
                        onLongPress: () => {
                          Navigator.push(
                            context,
                            MaterialPageRoute(builder: (context) =>  const CSESem3Sub2Curr()),
                          )
                        },
                        child: Container(
                ...
                child: Card(
                    ...
                    child: InkWell(
                        onLongPress: () => {
                          Navigator.push(
                            context,
                            MaterialPageRoute(builder: (context) =>  const CSESem3Sub2ebooks()),
                          )
                        },
                        child: Container(
                            decoration: const BoxDecoration(
                    ...
                    child: InkWell(
                        onLongPress: () => {
                          Navigator.push(
                            ...
                            MaterialPageRoute(
                                builder: (context) =>
                                const CSESem3Sub2Utube(title: 'web',)),
                          )
                        },
                        child: Container(
                            decoration: const BoxDecoration(
                ...
                child: Card(
                    ...
                    child: InkWell(
                        onLongPress: () => {
                          Navigator.push(
                            context,
                            MaterialPageRoute(builder: (context) =>  const CSESem3Sub2QTPaper()),
                          )
                        },
                        child: Container(
                            decoration: const BoxDecoration(
                ...
                child: Card(
                    ...
                    child: InkWell(
                        onLongPress: () => {
                          Navigator.push(
                            context,
                            MaterialPageRoute(builder: (context) =>  const CSESem3Sub2QTPaperFormat()),
                          )
                        },
                        child: Container(
                            decoration: const BoxDecoration(
                ...
                child: Card(
                    ...
                    child: InkWell(
                        onLongPress: () => {
                          Navigator.push(
                            context,
                            MaterialPageRoute(builder: (context) =>  const CSESem3Sub2SPrac()),
                          )
                        },
                        child: Container(
                            decoration: const BoxDecoration(
