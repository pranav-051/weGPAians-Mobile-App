...
class CSESem3Sub4ebooks extends StatefulWidget{
  const CSESem3Sub4ebooks({Key?key}) : super(key : key);
  @override
  _CSESem3Sub4ebooks createState() => _CSESem3Sub4ebooks();
}

class _CSESem3Sub4ebooks extends State<CSESem3Sub4ebooks>{
  //++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
  ...
  uploadDataToFirebase() async{
    ...
    //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    var CSESem3Sub4ebooks = pick.readAsBytesSync();
    //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    ...
    //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    UploadTask task = pdffile.putData(CSESem3Sub4ebooks);
    //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    ...
    //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    await FirebaseFirestore.instance.collection("CSESem3Sub4ebooks").doc().set({
      //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
  ...
  Widget build (BuildContext context) {
    return Scaffold(
      ...
      body: StreamBuilder(
        ...
        //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
        stream: FirebaseFirestore.instance.collection("CSESem3Sub4ebooks").snapshots(),
        //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
