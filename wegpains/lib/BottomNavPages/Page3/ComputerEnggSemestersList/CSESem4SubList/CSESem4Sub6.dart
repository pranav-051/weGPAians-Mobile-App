...
import 'CSESem4Sub6/CSESem4Sub6Curr.dart';
import 'CSESem4Sub6/CSESem4Sub6MP.dart';
import 'CSESem4Sub6/CSESem4Sub6QTPaper.dart';
import 'CSESem4Sub6/CSESem4Sub6QTPaperFormat.dart';
import 'CSESem4Sub6/CSESem4Sub6SPrac.dart';
import 'CSESem4Sub6/CSESem4Sub6Utube.dart';
import 'CSESem4Sub6/CSESem4Sub6ebooks.dart';



class CSESem4Sub6 extends StatefulWidget {
  const CSESem4Sub6 ({Key? key, required this.title}) : super(key: key);
  final String title;
  @override
  State<CSESem4Sub6> createState() => _CSESem4Sub6();
}

class _CSESem4Sub6 extends State<CSESem4Sub6> {
  bool semester = false;
  @override
                ...
                child: Card(
                    ...
                    child: InkWell(
                        onLongPress: () => {
                          Navigator.push(
                            context,
                            MaterialPageRoute(builder: (context) =>  const CSESem4Sub6Curr()),
                          )
                        },
                        child: Container(
                ...
                child: Card(
                    ...
                    child: InkWell(
                        onLongPress: () => {
                          Navigator.push(
                            context,
                            MaterialPageRoute(builder: (context) =>  const CSESem4Sub6ebooks()),
                          )
                        },
                        child: Container(
                            decoration: const BoxDecoration(
                    ...
                    child: InkWell(
                        onLongPress: () => {
                          Navigator.push(
                            ...
                            MaterialPageRoute(
                                builder: (context) =>
                                const CSESem4Sub6Utube(title: 'web',)),
                          )
                        },
                        child: Container(
                            decoration: const BoxDecoration(
                ...
                child: Card(
                    ...
                    child: InkWell(
                        onLongPress: () => {
                          Navigator.push(
                            context,
                            MaterialPageRoute(builder: (context) =>  const CSESem4Sub6QTPaper()),
                          )
                        },
                        child: Container(
                            decoration: const BoxDecoration(
                ...
                child: Card(
                    ...
                    child: InkWell(
                        onLongPress: () => {
                          Navigator.push(
                            context,
                            MaterialPageRoute(builder: (context) =>  const CSESem4Sub6QTPaperFormat()),
                          )
                        },
                        child: Container(
                            decoration: const BoxDecoration(
                ...
                child: Card(
                    ...
                    child: InkWell(
                        onLongPress: () => {
                          Navigator.push(
                            context,
                            MaterialPageRoute(builder: (context) =>  const CSESem4Sub6SPrac()),
                          )
                        },
                        child: Container(
                            decoration: const BoxDecoration(
