...
import 'CSESem4Sub2/CSESem4Sub2Curr.dart';
import 'CSESem4Sub2/CSESem4Sub2MP.dart';
import 'CSESem4Sub2/CSESem4Sub2QTPaper.dart';
import 'CSESem4Sub2/CSESem4Sub2QTPaperFormat.dart';
import 'CSESem4Sub2/CSESem4Sub2SPrac.dart';
import 'CSESem4Sub2/CSESem4Sub2Utube.dart';
import 'CSESem4Sub2/CSESem4Sub2ebooks.dart';



class CSESem4Sub2 extends StatefulWidget {
  const CSESem4Sub2 ({Key? key, required this.title}) : super(key: key);
  final String title;
  @override
  State<CSESem4Sub2> createState() => _CSESem4Sub2();
}

class _CSESem4Sub2 extends State<CSESem4Sub2> {
  bool semester = false;
  @override
                ...
                child: Card(
                    ...
                    child: InkWell(
                        onLongPress: () => {
                          Navigator.push(
                            context,
                            MaterialPageRoute(builder: (context) =>  const CSESem4Sub2Curr()),
                          )
                        },
                        child: Container(
                ...
                child: Card(
                    ...
                    child: InkWell(
                        onLongPress: () => {
                          Navigator.push(
                            context,
                            MaterialPageRoute(builder: (context) =>  const CSESem4Sub2ebooks()),
                          )
                        },
                        child: Container(
                            decoration: const BoxDecoration(
                    ...
                    child: InkWell(
                        onLongPress: () => {
                          Navigator.push(
                            ...
                            MaterialPageRoute(
                                builder: (context) =>
                                const CSESem4Sub2Utube(title: 'web',)),
                          )
                        },
                        child: Container(
                            decoration: const BoxDecoration(
                ...
                child: Card(
                    ...
                    child: InkWell(
                        onLongPress: () => {
                          Navigator.push(
                            context,
                            MaterialPageRoute(builder: (context) =>  const CSESem4Sub2QTPaper()),
                          )
                        },
                        child: Container(
                            decoration: const BoxDecoration(
                ...
                child: Card(
                    ...
                    child: InkWell(
                        onLongPress: () => {
                          Navigator.push(
                            context,
                            MaterialPageRoute(builder: (context) =>  const CSESem4Sub2QTPaperFormat()),
                          )
                        },
                        child: Container(
                            decoration: const BoxDecoration(
                ...
                child: Card(
                    ...
                    child: InkWell(
                        onLongPress: () => {
                          Navigator.push(
                            context,
                            MaterialPageRoute(builder: (context) =>  const CSESem4Sub2SPrac()),
                          )
                        },
                        child: Container(
                            decoration: const BoxDecoration(
