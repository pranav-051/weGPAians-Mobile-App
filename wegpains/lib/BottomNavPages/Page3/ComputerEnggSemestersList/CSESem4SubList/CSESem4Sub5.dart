...
import 'CSESem4Sub5/CSESem4Sub5Curr.dart';
import 'CSESem4Sub5/CSESem4Sub5MP.dart';
import 'CSESem4Sub5/CSESem4Sub5QTPaper.dart';
import 'CSESem4Sub5/CSESem4Sub5QTPaperFormat.dart';
import 'CSESem4Sub5/CSESem4Sub5SPrac.dart';
import 'CSESem4Sub5/CSESem4Sub5Utube.dart';
import 'CSESem4Sub5/CSESem4Sub5ebooks.dart';



class CSESem4Sub5 extends StatefulWidget {
  const CSESem4Sub5 ({Key? key, required this.title}) : super(key: key);
  final String title;
  @override
  State<CSESem4Sub5> createState() => _CSESem4Sub5();
}

class _CSESem4Sub5 extends State<CSESem4Sub5> {
  bool semester = false;
  @override
                ...
                child: Card(
                    ...
                    child: InkWell(
                        onLongPress: () => {
                          Navigator.push(
                            context,
                            MaterialPageRoute(builder: (context) =>  const CSESem4Sub5Curr()),
                          )
                        },
                        child: Container(
                ...
                child: Card(
                    ...
                    child: InkWell(
                        onLongPress: () => {
                          Navigator.push(
                            context,
                            MaterialPageRoute(builder: (context) =>  const CSESem4Sub5ebooks()),
                          )
                        },
                        child: Container(
                            decoration: const BoxDecoration(
                    ...
                    child: InkWell(
                        onLongPress: () => {
                          Navigator.push(
                            ...
                            MaterialPageRoute(
                                builder: (context) =>
                                const CSESem4Sub5Utube(title: 'web',)),
                          )
                        },
                        child: Container(
                            decoration: const BoxDecoration(
                ...
                child: Card(
                    ...
                    child: InkWell(
                        onLongPress: () => {
                          Navigator.push(
                            context,
                            MaterialPageRoute(builder: (context) =>  const CSESem4Sub5QTPaper()),
                          )
                        },
                        child: Container(
                            decoration: const BoxDecoration(
                ...
                child: Card(
                    ...
                    child: InkWell(
                        onLongPress: () => {
                          Navigator.push(
                            context,
                            MaterialPageRoute(builder: (context) =>  const CSESem4Sub5QTPaperFormat()),
                          )
                        },
                        child: Container(
                            decoration: const BoxDecoration(
                ...
                child: Card(
                    ...
                    child: InkWell(
                        onLongPress: () => {
                          Navigator.push(
                            context,
                            MaterialPageRoute(builder: (context) =>  const CSESem4Sub5SPrac()),
                          )
                        },
                        child: Container(
                            decoration: const BoxDecoration(
