...
import 'CSESem2Sub1/CSESem2Sub1Curr.dart';
import 'CSESem2Sub1/CSESem2Sub1QTPaper.dart';
import 'CSESem2Sub1/CSESem2Sub1QTPaperFormat.dart';
import 'CSESem2Sub1/CSESem2Sub1Utube.dart';
import 'CSESem2Sub1/CSESem2Sub1ebooks.dart';

class CSESem2Sub1 extends StatefulWidget {
  const CSESem2Sub1 ({Key? key, required this.title}) : super(key: key);
  final String title;
  @override
  State<CSESem2Sub1> createState() => _CSESem2Sub1();
}

class _CSESem2Sub1 extends State<CSESem2Sub1> {
  bool semester = false;
  @override
                ...
                child: Card(
                    ...
                    child: InkWell(
                        onLongPress: () => {
                          Navigator.push(
                            context,
                            MaterialPageRoute(builder: (context) =>  const CSESem2Sub1Curr()),
                          )
                        },
                        child: Container(
                ...
                child: Card(
                    ...
                    child: InkWell(
                        onLongPress: () => {
                          Navigator.push(
                            context,
                            MaterialPageRoute(builder: (context) =>  const CSESem2Sub1ebooks()),
                          )
                        },
                        child: Container(
                            decoration: const BoxDecoration(
                ...
                child: Card(
                    ...
                    child: InkWell(
                        onLongPress: () => {
                          Navigator.push(
                            context,
                            MaterialPageRoute(builder: (context) =>  const CSESem2Sub1QTPaper()),
                          )
                        },
                        child: Container(
                            decoration: const BoxDecoration(
                ...
                child: Card(
                    ...
                    child: InkWell(
                        onLongPress: () => {
                          Navigator.push(
                            context,
                            MaterialPageRoute(builder: (context) =>  const CSESem2Sub1QTPaperFormat()),
                          )
                        },
                        child: Container(
                            decoration: const BoxDecoration(
