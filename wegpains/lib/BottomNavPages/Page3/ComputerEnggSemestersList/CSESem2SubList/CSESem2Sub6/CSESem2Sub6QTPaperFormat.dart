...
class CSESem2Sub6QTPaperFormat extends StatefulWidget{
  const CSESem2Sub6QTPaperFormat({Key?key}) : super(key : key);
  @override
  _CSESem2Sub6QTPaperFormat createState() => _CSESem2Sub6QTPaperFormat();
}

class _CSESem2Sub6QTPaperFormat extends State<CSESem2Sub6QTPaperFormat>{
  //++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
  ...
  uploadDataToFirebase() async{
    ...
    //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    var CSESem2Sub6QTPaperFormat = pick.readAsBytesSync();
    //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    ...
    //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    UploadTask task = pdffile.putData(CSESem2Sub6QTPaperFormat);
    //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    ...
    //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    await FirebaseFirestore.instance.collection("CSESem2Sub6QTPaperFormat").doc().set({
      //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
  ...
  Widget build (BuildContext context) {
    return Scaffold(
      ...
      body: StreamBuilder(
        ...
        //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
        stream: FirebaseFirestore.instance.collection("CSESem2Sub6QTPaperFormat").snapshots(),
        //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
