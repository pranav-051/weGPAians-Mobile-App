...
class MechSem3Sub5 extends StatefulWidget {
  const MechSem3Sub5({key, required this.title});
  final String title;
  @override
  State<MechSem3Sub5> createState() => _MechSem3Sub5();
}

class _MechSem3Sub5 extends State<MechSem3Sub5> {
  bool semester = false;
  @override
