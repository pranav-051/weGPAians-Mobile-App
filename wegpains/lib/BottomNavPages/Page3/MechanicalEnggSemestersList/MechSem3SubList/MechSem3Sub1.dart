...
class MechSem3Sub1 extends StatefulWidget {
  const MechSem3Sub1({key, required this.title});
  final String title;
  @override
  State<MechSem3Sub1> createState() => _MechSem3Sub1();
}

class _MechSem3Sub1 extends State<MechSem3Sub1> {
  bool semester = false;
  @override
