...
class MechSem3Sub4 extends StatefulWidget {
  const MechSem3Sub4({key, required this.title});
  final String title;
  @override
  State<MechSem3Sub4> createState() => _MechSem3Sub4();
}

class _MechSem3Sub4 extends State<MechSem3Sub4> {
  bool semester = false;
  @override
