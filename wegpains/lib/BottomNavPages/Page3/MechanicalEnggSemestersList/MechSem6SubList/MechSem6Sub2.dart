...
class MechSem6Sub2 extends StatefulWidget {
  const MechSem6Sub2({key, required this.title});
  final String title;
  @override
  State<MechSem6Sub2> createState() => _MechSem6Sub2();
}

class _MechSem6Sub2 extends State<MechSem6Sub2> {
  bool semester = false;
  @override
