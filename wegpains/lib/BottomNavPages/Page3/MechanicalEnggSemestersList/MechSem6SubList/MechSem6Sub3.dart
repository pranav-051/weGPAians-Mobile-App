...
class MechSem6Sub3 extends StatefulWidget {
  const MechSem6Sub3({key, required this.title});
  final String title;
  @override
  State<MechSem6Sub3> createState() => _MechSem6Sub3();
}

class _MechSem6Sub3 extends State<MechSem6Sub3> {
  bool semester = false;
  @override
