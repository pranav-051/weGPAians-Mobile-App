...
class MechSem1Sub2 extends StatefulWidget {
  const MechSem1Sub2({key, required this.title});
  final String title;
  @override
  State<MechSem1Sub2> createState() => _MechSem1Sub2();
}

class _MechSem1Sub2 extends State<MechSem1Sub2> {
  bool semester = false;
  @override
