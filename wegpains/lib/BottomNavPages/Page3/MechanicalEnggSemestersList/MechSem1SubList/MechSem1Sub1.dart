...
class MechSem1Sub1 extends StatefulWidget {
  const MechSem1Sub1({key, required this.title});
  final String title;
  @override
  State<MechSem1Sub1> createState() => _MechSem1Sub1();
}

class _MechSem1Sub1 extends State<MechSem1Sub1> {
  bool semester = false;
  @override
