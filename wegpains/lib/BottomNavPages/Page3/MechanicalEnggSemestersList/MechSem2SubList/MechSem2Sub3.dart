...
class MechSem2Sub3 extends StatefulWidget {
  const MechSem2Sub3({key, required this.title});
  final String title;
  @override
  State<MechSem2Sub3> createState() => _MechSem2Sub3();
}

class _MechSem2Sub3 extends State<MechSem2Sub3> {
  bool semester = false;
  @override
