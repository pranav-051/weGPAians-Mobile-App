...
class MechSem2Sub2 extends StatefulWidget {
  const MechSem2Sub2({key, required this.title});
  final String title;
  @override
  State<MechSem2Sub2> createState() => _MechSem2Sub2();
}

class _MechSem2Sub2 extends State<MechSem2Sub2> {
  bool semester = false;
  @override
