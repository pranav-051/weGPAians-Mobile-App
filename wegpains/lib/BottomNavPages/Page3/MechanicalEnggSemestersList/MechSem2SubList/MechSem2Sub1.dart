...
class MechSem2Sub1 extends StatefulWidget {
  const MechSem2Sub1({key, required this.title});
  final String title;
  @override
  State<MechSem2Sub1> createState() => _MechSem2Sub1();
}

class _MechSem2Sub1 extends State<MechSem2Sub1> {
  bool semester = false;
  @override
