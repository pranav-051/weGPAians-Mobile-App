...
class MechSem2Sub5 extends StatefulWidget {
  const MechSem2Sub5({key, required this.title});
  final String title;
  @override
  State<MechSem2Sub5> createState() => _MechSem2Sub5();
}

class _MechSem2Sub5 extends State<MechSem2Sub5> {
  bool semester = false;
  @override
