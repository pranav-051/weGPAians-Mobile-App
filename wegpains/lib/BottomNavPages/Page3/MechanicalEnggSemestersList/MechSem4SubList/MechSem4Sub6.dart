...
class MechSem4Sub6 extends StatefulWidget {
  const MechSem4Sub6({key, required this.title});
  final String title;
  @override
  State<MechSem4Sub6> createState() => _MechSem4Sub6();
}

class _MechSem4Sub6 extends State<MechSem4Sub6> {
  bool semester = false;
  @override
