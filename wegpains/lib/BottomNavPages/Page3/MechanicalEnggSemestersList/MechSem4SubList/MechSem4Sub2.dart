...
class MechSem4Sub2 extends StatefulWidget {
  const MechSem4Sub2({key, required this.title});
  final String title;
  @override
  State<MechSem4Sub2> createState() => _MechSem4Sub2();
}

class _MechSem4Sub2 extends State<MechSem4Sub2> {
  bool semester = false;
  @override
