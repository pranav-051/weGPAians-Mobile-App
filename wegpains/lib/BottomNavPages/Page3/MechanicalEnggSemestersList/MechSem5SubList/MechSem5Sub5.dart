...
class MechSem5Sub5 extends StatefulWidget {
  const MechSem5Sub5({key, required this.title});
  final String title;
  @override
  State<MechSem5Sub5> createState() => _MechSem5Sub5();
}

class _MechSem5Sub5 extends State<MechSem5Sub5> {
  bool semester = false;
  @override
