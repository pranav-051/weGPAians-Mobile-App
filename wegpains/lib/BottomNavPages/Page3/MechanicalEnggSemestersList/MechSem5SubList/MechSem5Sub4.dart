...
class MechSem5Sub4 extends StatefulWidget {
  const MechSem5Sub4({key, required this.title});
  final String title;
  @override
  State<MechSem5Sub4> createState() => _MechSem5Sub4();
}

class _MechSem5Sub4 extends State<MechSem5Sub4> {
  bool semester = false;
  @override
