...
class MechSem5Sub6 extends StatefulWidget {
  const MechSem5Sub6({key, required this.title});
  final String title;
  @override
  State<MechSem5Sub6> createState() => _MechSem5Sub6();
}

class _MechSem5Sub6 extends State<MechSem5Sub6> {
  bool semester = false;
  @override
