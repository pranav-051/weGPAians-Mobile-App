...
class ENTcSem1Sub1 extends StatefulWidget {
  const ENTcSem1Sub1({key, required this.title});
  final String title;
  @override
  State<ENTcSem1Sub1> createState() => _ENTcSem1Sub1();
}

class _ENTcSem1Sub1 extends State<ENTcSem1Sub1> {
  bool semester = false;
  @override
