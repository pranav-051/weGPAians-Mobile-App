...
class ENTcSem1Sub6 extends StatefulWidget {
  const ENTcSem1Sub6({key, required this.title});
  final String title;
  @override
  State<ENTcSem1Sub6> createState() => _ENTcSem1Sub6();
}

class _ENTcSem1Sub6 extends State<ENTcSem1Sub6> {
  bool semester = false;
  @override
