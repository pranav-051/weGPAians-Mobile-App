...
class ENTcSem1Sub2 extends StatefulWidget {
  const ENTcSem1Sub2({key, required this.title});
  final String title;
  @override
  State<ENTcSem1Sub2> createState() => _ENTcSem1Sub2();
}

class _ENTcSem1Sub2 extends State<ENTcSem1Sub2> {
  bool semester = false;
  @override
