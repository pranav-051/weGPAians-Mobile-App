...
class ENTcSem4Sub1 extends StatefulWidget {
  const ENTcSem4Sub1({key, required this.title});
  final String title;
  @override
  State<ENTcSem4Sub1> createState() => _ENTcSem4Sub1();
}

class _ENTcSem4Sub1 extends State<ENTcSem4Sub1> {
  bool semester = false;
  @override
