...
class ENTcSem6Sub2 extends StatefulWidget {
  const ENTcSem6Sub2({key, required this.title});
  final String title;
  @override
  State<ENTcSem6Sub2> createState() => _ENTcSem6Sub2();
}

class _ENTcSem6Sub2 extends State<ENTcSem6Sub2> {
  bool semester = false;
  @override
