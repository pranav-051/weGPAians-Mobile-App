...
class ENTcSem6Sub5 extends StatefulWidget {
  const ENTcSem6Sub5({key, required this.title});
  final String title;
  @override
  State<ENTcSem6Sub5> createState() => _ENTcSem6Sub5();
}

class _ENTcSem6Sub5 extends State<ENTcSem6Sub5> {
  bool semester = false;
  @override
