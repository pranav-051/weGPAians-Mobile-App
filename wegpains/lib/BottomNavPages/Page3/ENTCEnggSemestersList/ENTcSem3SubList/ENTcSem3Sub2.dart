...
class ENTcSem3Sub2 extends StatefulWidget {
  const ENTcSem3Sub2({key, required this.title});
  final String title;
  @override
  State<ENTcSem3Sub2> createState() => _ENTcSem3Sub2();
}

class _ENTcSem3Sub2 extends State<ENTcSem3Sub2> {
  bool semester = false;
  @override
