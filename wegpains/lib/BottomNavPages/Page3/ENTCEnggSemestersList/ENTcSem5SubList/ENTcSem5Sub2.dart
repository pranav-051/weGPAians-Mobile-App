...
class ENTcSem5Sub2 extends StatefulWidget {
  const ENTcSem5Sub2({key, required this.title});
  final String title;
  @override
  State<ENTcSem5Sub2> createState() => _ENTcSem5Sub2();
}

class _ENTcSem5Sub2 extends State<ENTcSem5Sub2> {
  bool semester = false;
  @override
