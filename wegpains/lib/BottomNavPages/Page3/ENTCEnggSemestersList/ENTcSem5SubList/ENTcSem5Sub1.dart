...
class ENTcSem5Sub1 extends StatefulWidget {
  const ENTcSem5Sub1({key, required this.title});
  final String title;
  @override
  State<ENTcSem5Sub1> createState() => _ENTcSem5Sub1();
}

class _ENTcSem5Sub1 extends State<ENTcSem5Sub1> {
  bool semester = false;
  @override
