...
class ENTcSem2Sub3 extends StatefulWidget {
  const ENTcSem2Sub3({key, required this.title});
  final String title;
  @override
  State<ENTcSem2Sub3> createState() => _ENTcSem2Sub3();
}

class _ENTcSem2Sub3 extends State<ENTcSem2Sub3> {
  bool semester = false;
  @override
