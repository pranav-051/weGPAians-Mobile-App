...
class ENTcSem2Sub5 extends StatefulWidget {
  const ENTcSem2Sub5({key, required this.title});
  final String title;
  @override
  State<ENTcSem2Sub5> createState() => _ENTcSem2Sub5();
}

class _ENTcSem2Sub5 extends State<ENTcSem2Sub5> {
  bool semester = false;
  @override
