...
class ENTcSem2Sub2 extends StatefulWidget {
  const ENTcSem2Sub2({key, required this.title});
  final String title;
  @override
  State<ENTcSem2Sub2> createState() => _ENTcSem2Sub2();
}

class _ENTcSem2Sub2 extends State<ENTcSem2Sub2> {
  bool semester = false;
  @override
