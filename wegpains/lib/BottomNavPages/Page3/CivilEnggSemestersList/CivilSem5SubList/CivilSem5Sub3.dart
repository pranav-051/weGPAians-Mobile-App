...
class CivilSem5Sub3 extends StatefulWidget {
  const CivilSem5Sub3({key, required this.title});
  final String title;
  @override
  State<CivilSem5Sub3> createState() => _CivilSem5Sub3();
}

class _CivilSem5Sub3 extends State<CivilSem5Sub3> {
  bool semester = false;
  @override
