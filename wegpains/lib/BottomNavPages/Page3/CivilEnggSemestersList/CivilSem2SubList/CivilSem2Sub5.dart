...
class CivilSem2Sub5 extends StatefulWidget {
  const CivilSem2Sub5({key, required this.title});
  final String title;
  @override
  State<CivilSem2Sub5> createState() => _CivilSem2Sub5();
}

class _CivilSem2Sub5 extends State<CivilSem2Sub5> {
  bool semester = false;
  @override
