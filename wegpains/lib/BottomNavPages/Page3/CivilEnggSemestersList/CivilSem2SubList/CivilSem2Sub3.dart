...
class CivilSem2Sub3 extends StatefulWidget {
  const CivilSem2Sub3({key, required this.title});
  final String title;
  @override
  State<CivilSem2Sub3> createState() => _CivilSem2Sub3();
}

class _CivilSem2Sub3 extends State<CivilSem2Sub3> {
  bool semester = false;
  @override
