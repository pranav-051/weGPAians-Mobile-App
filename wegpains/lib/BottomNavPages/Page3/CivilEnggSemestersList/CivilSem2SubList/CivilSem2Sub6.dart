...
class CivilSem2Sub6 extends StatefulWidget {
  const CivilSem2Sub6({key, required this.title});
  final String title;
  @override
  State<CivilSem2Sub6> createState() => _CivilSem2Sub6();
}

class _CivilSem2Sub6 extends State<CivilSem2Sub6> {
  bool semester = false;
  @override
