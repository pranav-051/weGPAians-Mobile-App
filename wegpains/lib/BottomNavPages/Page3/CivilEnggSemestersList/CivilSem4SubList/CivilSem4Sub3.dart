...
class CivilSem4Sub3 extends StatefulWidget {
  const CivilSem4Sub3({key, required this.title});
  final String title;
  @override
  State<CivilSem4Sub3> createState() => _CivilSem4Sub3();
}

class _CivilSem4Sub3 extends State<CivilSem4Sub3> {
  bool semester = false;
  @override
