...
class CivilSem4Sub1 extends StatefulWidget {
  const CivilSem4Sub1({key, required this.title});
  final String title;
  @override
  State<CivilSem4Sub1> createState() => _CivilSem4Sub1();
}

class _CivilSem4Sub1 extends State<CivilSem4Sub1> {
  bool semester = false;
  @override
