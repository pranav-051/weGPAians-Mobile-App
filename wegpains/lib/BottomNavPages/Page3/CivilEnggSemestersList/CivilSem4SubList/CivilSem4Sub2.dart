...
class CivilSem4Sub2 extends StatefulWidget {
  const CivilSem4Sub2({key, required this.title});
  final String title;
  @override
  State<CivilSem4Sub2> createState() => _CivilSem4Sub2();
}

class _CivilSem4Sub2 extends State<CivilSem4Sub2> {
  bool semester = false;
  @override
