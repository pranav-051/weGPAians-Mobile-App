...
class CivilSem1Sub4 extends StatefulWidget {
  const CivilSem1Sub4({key, required this.title});
  final String title;
  @override
  State<CivilSem1Sub4> createState() => _CivilSem1Sub4();
}

class _CivilSem1Sub4 extends State<CivilSem1Sub4> {
  bool semester = false;
  @override
