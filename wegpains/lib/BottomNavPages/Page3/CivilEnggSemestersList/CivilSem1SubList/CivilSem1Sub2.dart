...
class CivilSem1Sub2 extends StatefulWidget {
  const CivilSem1Sub2({key, required this.title});
  final String title;
  @override
  State<CivilSem1Sub2> createState() => _CivilSem1Sub2();
}

class _CivilSem1Sub2 extends State<CivilSem1Sub2> {
  bool semester = false;
  @override
