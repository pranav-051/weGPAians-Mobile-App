...
class CivilSem1Sub5 extends StatefulWidget {
  const CivilSem1Sub5({key, required this.title});
  final String title;
  @override
  State<CivilSem1Sub5> createState() => _CivilSem1Sub5();
}

class _CivilSem1Sub5 extends State<CivilSem1Sub5> {
  bool semester = false;
  @override
