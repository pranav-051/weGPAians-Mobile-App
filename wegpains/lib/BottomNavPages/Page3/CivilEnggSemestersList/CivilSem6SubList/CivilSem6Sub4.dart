...
class CivilSem6Sub4 extends StatefulWidget {
  const CivilSem6Sub4({key, required this.title});
  final String title;
  @override
  State<CivilSem6Sub4> createState() => _CivilSem6Sub4();
}

class _CivilSem6Sub4 extends State<CivilSem6Sub4> {
  bool semester = false;
  @override
