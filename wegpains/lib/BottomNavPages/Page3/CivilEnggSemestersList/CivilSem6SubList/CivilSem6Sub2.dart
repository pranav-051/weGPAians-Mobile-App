...
class CivilSem6Sub2 extends StatefulWidget {
  const CivilSem6Sub2({key, required this.title});
  final String title;
  @override
  State<CivilSem6Sub2> createState() => _CivilSem6Sub2();
}

class _CivilSem6Sub2 extends State<CivilSem6Sub2> {
  bool semester = false;
  @override
