...
class CivilSem6Sub6 extends StatefulWidget {
  const CivilSem6Sub6({key, required this.title});
  final String title;
  @override
  State<CivilSem6Sub6> createState() => _CivilSem6Sub6();
}

class _CivilSem6Sub6 extends State<CivilSem6Sub6> {
  bool semester = false;
  @override
