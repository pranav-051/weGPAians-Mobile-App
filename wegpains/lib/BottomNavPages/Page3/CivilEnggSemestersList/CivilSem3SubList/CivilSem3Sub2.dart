...
class CivilSem3Sub2 extends StatefulWidget {
  const CivilSem3Sub2({key, required this.title});
  final String title;
  @override
  State<CivilSem3Sub2> createState() => _CivilSem3Sub2();
}

class _CivilSem3Sub2 extends State<CivilSem3Sub2> {
  bool semester = false;
  @override
