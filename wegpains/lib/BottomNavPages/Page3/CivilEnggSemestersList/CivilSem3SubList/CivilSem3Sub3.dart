...
class CivilSem3Sub3 extends StatefulWidget {
  const CivilSem3Sub3({key, required this.title});
  final String title;
  @override
  State<CivilSem3Sub3> createState() => _CivilSem3Sub3();
}

class _CivilSem3Sub3 extends State<CivilSem3Sub3> {
  bool semester = false;
  @override
