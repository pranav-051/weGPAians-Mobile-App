...
class CivilSem3Sub4 extends StatefulWidget {
  const CivilSem3Sub4({key, required this.title});
  final String title;
  @override
  State<CivilSem3Sub4> createState() => _CivilSem3Sub4();
}

class _CivilSem3Sub4 extends State<CivilSem3Sub4> {
  bool semester = false;
  @override
