...
class ITSem4Sub2 extends StatefulWidget {
  const ITSem4Sub2({key, required this.title});
  final String title;
  @override
  State<ITSem4Sub2> createState() => _ITSem4Sub2();
}

class _ITSem4Sub2 extends State<ITSem4Sub2> {
  bool semester = false;
  @override
