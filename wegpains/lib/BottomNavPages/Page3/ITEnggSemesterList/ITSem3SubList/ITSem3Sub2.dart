...
class ITSem3Sub2 extends StatefulWidget {
  const ITSem3Sub2({key, required this.title});
  final String title;
  @override
  State<ITSem3Sub2> createState() => _ITSem3Sub2();
}

class _ITSem3Sub2 extends State<ITSem3Sub2> {
  bool semester = false;
  @override
