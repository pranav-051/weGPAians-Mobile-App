...
class ITSem2Sub6 extends StatefulWidget {
  const ITSem2Sub6({key, required this.title});
  final String title;
  @override
  State<ITSem2Sub6> createState() => _ITSem2Sub6();
}

class _ITSem2Sub6 extends State<ITSem2Sub6> {
  bool semester = false;
  @override
