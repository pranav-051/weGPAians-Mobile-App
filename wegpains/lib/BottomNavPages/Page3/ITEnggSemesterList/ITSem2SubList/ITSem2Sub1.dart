...
class ITSem2Sub1 extends StatefulWidget {
  const ITSem2Sub1({key, required this.title});
  final String title;
  @override
  State<ITSem2Sub1> createState() => _ITSem2Sub1();
}

class _ITSem2Sub1 extends State<ITSem2Sub1> {
  bool semester = false;
  @override
