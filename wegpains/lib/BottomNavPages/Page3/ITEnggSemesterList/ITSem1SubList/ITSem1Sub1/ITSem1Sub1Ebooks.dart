...
class ITSem1Sub1Ebooks extends StatefulWidget{
  const ITSem1Sub1Ebooks({Key?key}) : super(key : key);
  @override
  _ITSem1Sub1Ebooks createState() => _ITSem1Sub1Ebooks();
}

class _ITSem1Sub1Ebooks extends State<ITSem1Sub1Ebooks>{
  //++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
  ...
  uploadDataToFirebase() async{
    ...
    //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    var ITSem1Sub1Ebooks = pick.readAsBytesSync();
    //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    ...
    //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    UploadTask task = pdffile.putData(ITSem1Sub1Ebooks);
    //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    ...
    //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    await FirebaseFirestore.instance.collection("ITSem1Sub1Ebooks").doc().set({
      //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
  ...
  Widget build (BuildContext context) {
    return Scaffold(
      ...
      body: StreamBuilder(
        ...
        //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
        stream: FirebaseFirestore.instance.collection("ITSem1Sub1Ebooks").snapshots(),
        //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
