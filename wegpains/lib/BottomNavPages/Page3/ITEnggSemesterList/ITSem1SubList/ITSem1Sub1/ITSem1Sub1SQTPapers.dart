...
class ITSem1Sub1SQTPapers extends StatefulWidget{
  const ITSem1Sub1SQTPapers({Key?key}) : super(key : key);
  @override
  _ITSem1Sub1SQTPapers createState() => _ITSem1Sub1SQTPapers();
}

class _ITSem1Sub1SQTPapers extends State<ITSem1Sub1SQTPapers>{
  //++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
  ...
  uploadDataToFirebase() async{
    ...
    //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    var ITSem1Sub1SQTPapers = pick.readAsBytesSync();
    //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    ...
    //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    UploadTask task = pdffile.putData(ITSem1Sub1SQTPapers);
    //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    ...
    //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    await FirebaseFirestore.instance.collection("ITSem1Sub1SQTPapers").doc().set({
      //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
  ...
  Widget build (BuildContext context) {
    return Scaffold(
      ...
      body: StreamBuilder(
        ...
        //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
        stream: FirebaseFirestore.instance.collection("ITSem1Sub1SQTPapers").snapshots(),
        //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
