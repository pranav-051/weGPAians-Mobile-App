...
class ITSem1Sub3QTPapers extends StatefulWidget{
  const ITSem1Sub3QTPapers({Key?key}) : super(key : key);
  @override
  _ITSem1Sub3QTPapers createState() => _ITSem1Sub3QTPapers();
}

class _ITSem1Sub3QTPapers extends State<ITSem1Sub3QTPapers>{
  //++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
  ...
  uploadDataToFirebase() async{
    ...
    //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    var ITSem1Sub3QTPapers = pick.readAsBytesSync();
    //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    ...
    //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    UploadTask task = pdffile.putData(ITSem1Sub3QTPapers);
    //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    ...
    //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    await FirebaseFirestore.instance.collection("ITSem1Sub3QTPapers").doc().set({
      //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
  ...
  Widget build (BuildContext context) {
    return Scaffold(
      ...
      body: StreamBuilder(
        ...
        //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
        stream: FirebaseFirestore.instance.collection("ITSem1Sub3QTPapers").snapshots(),
        //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
