...
class ITSem1Sub6 extends StatefulWidget {
  const ITSem1Sub6({key, required this.title});
  final String title;
  @override
  State<ITSem1Sub6> createState() => _ITSem1Sub6();
}

class _ITSem1Sub6 extends State<ITSem1Sub6> {
  bool semester = false;
  @override
