...
class ITSem6Sub6 extends StatefulWidget {
  const ITSem6Sub6({key, required this.title});
  final String title;
  @override
  State<ITSem6Sub6> createState() => _ITSem6Sub6();
}

class _ITSem6Sub6 extends State<ITSem6Sub6> {
  bool semester = false;
  @override
