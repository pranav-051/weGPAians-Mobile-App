...
class ITSem6Sub3 extends StatefulWidget {
  const ITSem6Sub3({key, required this.title});
  final String title;
  @override
  State<ITSem6Sub3> createState() => _ITSem6Sub3();
}

class _ITSem6Sub3 extends State<ITSem6Sub3> {
  bool semester = false;
  @override
