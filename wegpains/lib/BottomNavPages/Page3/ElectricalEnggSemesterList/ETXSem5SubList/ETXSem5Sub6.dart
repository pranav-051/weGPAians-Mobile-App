...
class ETXSem5Sub6 extends StatefulWidget {
  const ETXSem5Sub6({key, required this.title});
  final String title;
  @override
  State<ETXSem5Sub6> createState() => _ETXSem5Sub6();
}

class _ETXSem5Sub6 extends State<ETXSem5Sub6> {
  bool semester = false;
  @override
