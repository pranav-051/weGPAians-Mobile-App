...
class ETXSem5Sub5 extends StatefulWidget {
  const ETXSem5Sub5({key, required this.title});
  final String title;
  @override
  State<ETXSem5Sub5> createState() => _ETXSem5Sub5();
}

class _ETXSem5Sub5 extends State<ETXSem5Sub5> {
  bool semester = false;
  @override
