...
class ETXSem6Sub3 extends StatefulWidget {
  const ETXSem6Sub3({key, required this.title});
  final String title;
  @override
  State<ETXSem6Sub3> createState() => _ETXSem6Sub3();
}

class _ETXSem6Sub3 extends State<ETXSem6Sub3> {
  bool semester = false;
  @override
