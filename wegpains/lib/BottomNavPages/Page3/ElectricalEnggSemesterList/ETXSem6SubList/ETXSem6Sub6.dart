...
class ETXSem6Sub6 extends StatefulWidget {
  const ETXSem6Sub6({key, required this.title});
  final String title;
  @override
  State<ETXSem6Sub6> createState() => _ETXSem6Sub6();
}

class _ETXSem6Sub6 extends State<ETXSem6Sub6> {
  bool semester = false;
  @override
