...
class ETXSem2Sub6 extends StatefulWidget {
  const ETXSem2Sub6({key, required this.title});
  final String title;
  @override
  State<ETXSem2Sub6> createState() => _ETXSem2Sub6();
}

class _ETXSem2Sub6 extends State<ETXSem2Sub6> {
  bool semester = false;
  @override
