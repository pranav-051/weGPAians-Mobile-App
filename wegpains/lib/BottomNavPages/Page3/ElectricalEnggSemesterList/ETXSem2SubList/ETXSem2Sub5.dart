...
class ETXSem2Sub5 extends StatefulWidget {
  const ETXSem2Sub5({key, required this.title});
  final String title;
  @override
  State<ETXSem2Sub5> createState() => _ETXSem2Sub5();
}

class _ETXSem2Sub5 extends State<ETXSem2Sub5> {
  bool semester = false;
  @override
