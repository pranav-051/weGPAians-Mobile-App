...
class ETXSem2Sub2 extends StatefulWidget {
  const ETXSem2Sub2({key, required this.title});
  final String title;
  @override
  State<ETXSem2Sub2> createState() => _ETXSem2Sub2();
}

class _ETXSem2Sub2 extends State<ETXSem2Sub2> {
  bool semester = false;
  @override
