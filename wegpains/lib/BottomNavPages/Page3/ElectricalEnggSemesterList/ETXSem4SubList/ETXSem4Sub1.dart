...
class ETXSem4Sub1 extends StatefulWidget {
  const ETXSem4Sub1({key, required this.title});
  final String title;
  @override
  State<ETXSem4Sub1> createState() => _ETXSem4Sub1();
}

class _ETXSem4Sub1 extends State<ETXSem4Sub1> {
  bool semester = false;
  @override
