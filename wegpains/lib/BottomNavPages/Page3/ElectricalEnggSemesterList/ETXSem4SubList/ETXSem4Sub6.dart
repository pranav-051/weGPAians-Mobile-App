...
class ETXSem4Sub6 extends StatefulWidget {
  const ETXSem4Sub6({key, required this.title});
  final String title;
  @override
  State<ETXSem4Sub6> createState() => _ETXSem4Sub6();
}

class _ETXSem4Sub6 extends State<ETXSem4Sub6> {
  bool semester = false;
  @override
