...
class ETXSem3Sub3 extends StatefulWidget {
  const ETXSem3Sub3({key, required this.title});
  final String title;
  @override
  State<ETXSem3Sub3> createState() => _ETXSem3Sub3();
}

class _ETXSem3Sub3 extends State<ETXSem3Sub3> {
  bool semester = false;
  @override
