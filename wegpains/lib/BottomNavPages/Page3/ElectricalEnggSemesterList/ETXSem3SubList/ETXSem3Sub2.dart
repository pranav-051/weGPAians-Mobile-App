...
class ETXSem3Sub2 extends StatefulWidget {
  const ETXSem3Sub2({key, required this.title});
  final String title;
  @override
  State<ETXSem3Sub2> createState() => _ETXSem3Sub2();
}

class _ETXSem3Sub2 extends State<ETXSem3Sub2> {
  bool semester = false;
  @override
