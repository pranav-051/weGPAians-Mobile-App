...
class ETXSem3Sub4 extends StatefulWidget {
  const ETXSem3Sub4({key, required this.title});
  final String title;
  @override
  State<ETXSem3Sub4> createState() => _ETXSem3Sub4();
}

class _ETXSem3Sub4 extends State<ETXSem3Sub4> {
  bool semester = false;
  @override
