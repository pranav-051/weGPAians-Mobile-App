...
class ETXSem3Sub1 extends StatefulWidget {
  const ETXSem3Sub1({key, required this.title});
  final String title;
  @override
  State<ETXSem3Sub1> createState() => _ETXSem3Sub1();
}

class _ETXSem3Sub1 extends State<ETXSem3Sub1> {
  bool semester = false;
  @override
