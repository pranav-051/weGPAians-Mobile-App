...
class ENTcSem6Sub6 extends StatefulWidget {
  const ENTcSem6Sub6({key, required this.title});
  final String title;
  @override
  State<ENTcSem6Sub6> createState() => _ENTcSem6Sub6();
}

class _ENTcSem6Sub6 extends State<ENTcSem6Sub6> {
  bool semester = false;
  @override
