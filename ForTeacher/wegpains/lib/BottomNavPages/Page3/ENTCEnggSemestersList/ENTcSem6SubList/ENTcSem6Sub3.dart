...
class ENTcSem6Sub3 extends StatefulWidget {
  const ENTcSem6Sub3({key, required this.title});
  final String title;
  @override
  State<ENTcSem6Sub3> createState() => _ENTcSem6Sub3();
}

class _ENTcSem6Sub3 extends State<ENTcSem6Sub3> {
  bool semester = false;
  @override
