...
class ENTcSem6Sub1 extends StatefulWidget {
  const ENTcSem6Sub1({key, required this.title});
  final String title;
  @override
  State<ENTcSem6Sub1> createState() => _ENTcSem6Sub1();
}

class _ENTcSem6Sub1 extends State<ENTcSem6Sub1> {
  bool semester = false;
  @override
