...
class ENTcSem6Sub4 extends StatefulWidget {
  const ENTcSem6Sub4({key, required this.title});
  final String title;
  @override
  State<ENTcSem6Sub4> createState() => _ENTcSem6Sub4();
}

class _ENTcSem6Sub4 extends State<ENTcSem6Sub4> {
  bool semester = false;
  @override
