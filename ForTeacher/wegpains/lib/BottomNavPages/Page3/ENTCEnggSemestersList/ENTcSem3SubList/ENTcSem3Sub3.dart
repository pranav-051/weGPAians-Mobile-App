...
class ENTcSem3Sub3 extends StatefulWidget {
  const ENTcSem3Sub3({key, required this.title});
  final String title;
  @override
  State<ENTcSem3Sub3> createState() => _ENTcSem3Sub3();
}

class _ENTcSem3Sub3 extends State<ENTcSem3Sub3> {
  bool semester = false;
  @override
