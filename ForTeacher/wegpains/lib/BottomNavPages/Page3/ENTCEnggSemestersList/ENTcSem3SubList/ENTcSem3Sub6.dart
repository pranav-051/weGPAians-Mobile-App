...
class ENTcSem3Sub6 extends StatefulWidget {
  const ENTcSem3Sub6({key, required this.title});
  final String title;
  @override
  State<ENTcSem3Sub6> createState() => _ENTcSem3Sub6();
}

class _ENTcSem3Sub6 extends State<ENTcSem3Sub6> {
  bool semester = false;
  @override
