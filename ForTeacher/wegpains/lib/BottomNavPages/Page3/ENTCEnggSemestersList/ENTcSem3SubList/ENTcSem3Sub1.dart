...
class ENTcSem3Sub1 extends StatefulWidget {
  const ENTcSem3Sub1({key, required this.title});
  final String title;
  @override
  State<ENTcSem3Sub1> createState() => _ENTcSem3Sub1();
}

class _ENTcSem3Sub1 extends State<ENTcSem3Sub1> {
  bool semester = false;
  @override
