...
class ENTcSem1Sub3 extends StatefulWidget {
  const ENTcSem1Sub3({key, required this.title});
  final String title;
  @override
  State<ENTcSem1Sub3> createState() => _ENTcSem1Sub3();
}

class _ENTcSem1Sub3 extends State<ENTcSem1Sub3> {
  bool semester = false;
  @override
