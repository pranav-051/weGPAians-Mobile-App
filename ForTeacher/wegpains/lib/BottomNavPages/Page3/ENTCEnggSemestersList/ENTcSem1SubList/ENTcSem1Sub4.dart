...
class ENTcSem1Sub4 extends StatefulWidget {
  const ENTcSem1Sub4({key, required this.title});
  final String title;
  @override
  State<ENTcSem1Sub4> createState() => _ENTcSem1Sub4();
}

class _ENTcSem1Sub4 extends State<ENTcSem1Sub4> {
  bool semester = false;
  @override
