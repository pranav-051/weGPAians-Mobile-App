...
class ENTcSem5Sub6 extends StatefulWidget {
  const ENTcSem5Sub6({key, required this.title});
  final String title;
  @override
  State<ENTcSem5Sub6> createState() => _ENTcSem5Sub6();
}

class _ENTcSem5Sub6 extends State<ENTcSem5Sub6> {
  bool semester = false;
  @override
