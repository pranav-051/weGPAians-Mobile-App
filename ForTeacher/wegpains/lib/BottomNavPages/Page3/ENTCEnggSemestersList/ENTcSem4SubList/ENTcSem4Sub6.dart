...
class ENTcSem4Sub6 extends StatefulWidget {
  const ENTcSem4Sub6({key, required this.title});
  final String title;
  @override
  State<ENTcSem4Sub6> createState() => _ENTcSem4Sub6();
}

class _ENTcSem4Sub6 extends State<ENTcSem4Sub6> {
  bool semester = false;
  @override
