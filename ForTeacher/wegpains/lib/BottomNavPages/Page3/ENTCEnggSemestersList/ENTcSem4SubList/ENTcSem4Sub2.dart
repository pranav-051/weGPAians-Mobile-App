...
class ENTcSem4Sub2 extends StatefulWidget {
  const ENTcSem4Sub2({key, required this.title});
  final String title;
  @override
  State<ENTcSem4Sub2> createState() => _ENTcSem4Sub2();
}

class _ENTcSem4Sub2 extends State<ENTcSem4Sub2> {
  bool semester = false;
  @override
