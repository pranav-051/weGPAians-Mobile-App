...
class ENTcSem4Sub4 extends StatefulWidget {
  const ENTcSem4Sub4({key, required this.title});
  final String title;
  @override
  State<ENTcSem4Sub4> createState() => _ENTcSem4Sub4();
}

class _ENTcSem4Sub4 extends State<ENTcSem4Sub4> {
  bool semester = false;
  @override
