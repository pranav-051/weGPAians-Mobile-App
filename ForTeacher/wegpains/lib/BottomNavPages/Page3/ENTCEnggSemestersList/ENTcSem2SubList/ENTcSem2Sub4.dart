...
class ENTcSem2Sub4 extends StatefulWidget {
  const ENTcSem2Sub4({key, required this.title});
  final String title;
  @override
  State<ENTcSem2Sub4> createState() => _ENTcSem2Sub4();
}

class _ENTcSem2Sub4 extends State<ENTcSem2Sub4> {
  bool semester = false;
  @override
