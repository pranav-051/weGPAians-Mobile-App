...
class ENTcSem2Sub1 extends StatefulWidget {
  const ENTcSem2Sub1({key, required this.title});
  final String title;
  @override
  State<ENTcSem2Sub1> createState() => _ENTcSem2Sub1();
}

class _ENTcSem2Sub1 extends State<ENTcSem2Sub1> {
  bool semester = false;
  @override
