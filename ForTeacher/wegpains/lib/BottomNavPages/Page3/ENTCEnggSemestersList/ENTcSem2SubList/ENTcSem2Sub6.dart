...
class ENTcSem2Sub6 extends StatefulWidget {
  const ENTcSem2Sub6({key, required this.title});
  final String title;
  @override
  State<ENTcSem2Sub6> createState() => _ENTcSem2Sub6();
}

class _ENTcSem2Sub6 extends State<ENTcSem2Sub6> {
  bool semester = false;
  @override
