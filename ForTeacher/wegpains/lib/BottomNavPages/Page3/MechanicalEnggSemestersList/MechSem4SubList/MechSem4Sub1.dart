...
class MechSem4Sub1 extends StatefulWidget {
  const MechSem4Sub1({key, required this.title});
  final String title;
  @override
  State<MechSem4Sub1> createState() => _MechSem4Sub1();
}

class _MechSem4Sub1 extends State<MechSem4Sub1> {
  bool semester = false;
  @override
