...
class MechSem4Sub5 extends StatefulWidget {
  const MechSem4Sub5({key, required this.title});
  final String title;
  @override
  State<MechSem4Sub5> createState() => _MechSem4Sub5();
}

class _MechSem4Sub5 extends State<MechSem4Sub5> {
  bool semester = false;
  @override
