...
class MechSem4Sub3 extends StatefulWidget {
  const MechSem4Sub3({key, required this.title});
  final String title;
  @override
  State<MechSem4Sub3> createState() => _MechSem4Sub3();
}

class _MechSem4Sub3 extends State<MechSem4Sub3> {
  bool semester = false;
  @override
