...
class MechSem4Sub4 extends StatefulWidget {
  const MechSem4Sub4({key, required this.title});
  final String title;
  @override
  State<MechSem4Sub4> createState() => _MechSem4Sub4();
}

class _MechSem4Sub4 extends State<MechSem4Sub4> {
  bool semester = false;
  @override
