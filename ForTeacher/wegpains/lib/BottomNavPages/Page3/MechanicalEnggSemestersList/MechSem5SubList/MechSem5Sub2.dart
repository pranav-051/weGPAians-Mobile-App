...
class MechSem5Sub2 extends StatefulWidget {
  const MechSem5Sub2({key, required this.title});
  final String title;
  @override
  State<MechSem5Sub2> createState() => _MechSem5Sub2();
}

class _MechSem5Sub2 extends State<MechSem5Sub2> {
  bool semester = false;
  @override
