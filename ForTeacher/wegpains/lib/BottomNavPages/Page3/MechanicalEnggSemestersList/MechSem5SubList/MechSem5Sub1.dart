...
class MechSem5Sub1 extends StatefulWidget {
  const MechSem5Sub1({key, required this.title});
  final String title;
  @override
  State<MechSem5Sub1> createState() => _MechSem5Sub1();
}

class _MechSem5Sub1 extends State<MechSem5Sub1> {
  bool semester = false;
  @override
