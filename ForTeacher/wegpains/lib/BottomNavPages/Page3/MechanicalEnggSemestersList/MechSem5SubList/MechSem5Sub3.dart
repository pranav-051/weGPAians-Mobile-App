...
class MechSem5Sub3 extends StatefulWidget {
  const MechSem5Sub3({key, required this.title});
  final String title;
  @override
  State<MechSem5Sub3> createState() => _MechSem5Sub3();
}

class _MechSem5Sub3 extends State<MechSem5Sub3> {
  bool semester = false;
  @override
