...
class MechSem1Sub3 extends StatefulWidget {
  const MechSem1Sub3({key, required this.title});
  final String title;
  @override
  State<MechSem1Sub3> createState() => _MechSem1Sub3();
}

class _MechSem1Sub3 extends State<MechSem1Sub3> {
  bool semester = false;
  @override
