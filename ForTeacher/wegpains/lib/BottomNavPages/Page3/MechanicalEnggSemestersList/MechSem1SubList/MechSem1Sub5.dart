...
class MechSem1Sub5 extends StatefulWidget {
  const MechSem1Sub5({key, required this.title});
  final String title;
  @override
  State<MechSem1Sub5> createState() => _MechSem1Sub5();
}

class _MechSem1Sub5 extends State<MechSem1Sub5> {
  bool semester = false;
  @override
