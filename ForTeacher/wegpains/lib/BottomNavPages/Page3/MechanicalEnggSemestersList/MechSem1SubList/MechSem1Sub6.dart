...
class MechSem1Sub6 extends StatefulWidget {
  const MechSem1Sub6({key, required this.title});
  final String title;
  @override
  State<MechSem1Sub6> createState() => _MechSem1Sub6();
}

class _MechSem1Sub6 extends State<MechSem1Sub6> {
  bool semester = false;
  @override
