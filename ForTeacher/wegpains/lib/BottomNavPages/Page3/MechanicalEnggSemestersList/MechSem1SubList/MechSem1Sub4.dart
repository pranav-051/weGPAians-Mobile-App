...
class MechSem1Sub4 extends StatefulWidget {
  const MechSem1Sub4({key, required this.title});
  final String title;
  @override
  State<MechSem1Sub4> createState() => _MechSem1Sub4();
}

class _MechSem1Sub4 extends State<MechSem1Sub4> {
  bool semester = false;
  @override
