...
class MechSem2Sub4 extends StatefulWidget {
  const MechSem2Sub4({key, required this.title});
  final String title;
  @override
  State<MechSem2Sub4> createState() => _MechSem2Sub4();
}

class _MechSem2Sub4 extends State<MechSem2Sub4> {
  bool semester = false;
  @override
