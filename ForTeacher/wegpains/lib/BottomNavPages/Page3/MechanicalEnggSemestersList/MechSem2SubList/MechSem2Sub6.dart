...
class MechSem2Sub6 extends StatefulWidget {
  const MechSem2Sub6({key, required this.title});
  final String title;
  @override
  State<MechSem2Sub6> createState() => _MechSem2Sub6();
}

class _MechSem2Sub6 extends State<MechSem2Sub6> {
  bool semester = false;
  @override
