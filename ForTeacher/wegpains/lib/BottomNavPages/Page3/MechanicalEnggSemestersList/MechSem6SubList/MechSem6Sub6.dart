...
class MechSem6Sub6 extends StatefulWidget {
  const MechSem6Sub6({key, required this.title});
  final String title;
  @override
  State<MechSem6Sub6> createState() => _MechSem6Sub6();
}

class _MechSem6Sub6 extends State<MechSem6Sub6> {
  bool semester = false;
  @override
