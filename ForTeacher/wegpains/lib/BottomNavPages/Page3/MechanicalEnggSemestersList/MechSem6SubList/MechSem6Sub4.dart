...
class MechSem6Sub4 extends StatefulWidget {
  const MechSem6Sub4({key, required this.title});
  final String title;
  @override
  State<MechSem6Sub4> createState() => _MechSem6Sub4();
}

class _MechSem6Sub4 extends State<MechSem6Sub4> {
  bool semester = false;
  @override
