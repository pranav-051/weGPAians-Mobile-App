...
class MechSem6Sub1 extends StatefulWidget {
  const MechSem6Sub1({key, required this.title});
  final String title;
  @override
  State<MechSem6Sub1> createState() => _MechSem6Sub1();
}

class _MechSem6Sub1 extends State<MechSem6Sub1> {
  bool semester = false;
  @override
