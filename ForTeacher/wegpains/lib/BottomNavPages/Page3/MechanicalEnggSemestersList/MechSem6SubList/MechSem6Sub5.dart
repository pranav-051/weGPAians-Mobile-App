...
class MechSem6Sub5 extends StatefulWidget {
  const MechSem6Sub5({key, required this.title});
  final String title;
  @override
  State<MechSem6Sub5> createState() => _MechSem6Sub5();
}

class _MechSem6Sub5 extends State<MechSem6Sub5> {
  bool semester = false;
  @override
