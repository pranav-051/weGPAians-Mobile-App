...
class MechSem3Sub2 extends StatefulWidget {
  const MechSem3Sub2({key, required this.title});
  final String title;
  @override
  State<MechSem3Sub2> createState() => _MechSem3Sub2();
}

class _MechSem3Sub2 extends State<MechSem3Sub2> {
  bool semester = false;
  @override
