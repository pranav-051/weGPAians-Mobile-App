...
class MechSem3Sub6 extends StatefulWidget {
  const MechSem3Sub6({key, required this.title});
  final String title;
  @override
  State<MechSem3Sub6> createState() => _MechSem3Sub6();
}

class _MechSem3Sub6 extends State<MechSem3Sub6> {
  bool semester = false;
  @override
