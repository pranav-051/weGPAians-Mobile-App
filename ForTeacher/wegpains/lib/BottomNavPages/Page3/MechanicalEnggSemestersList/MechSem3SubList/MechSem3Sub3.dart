...
class MechSem3Sub3 extends StatefulWidget {
  const MechSem3Sub3({key, required this.title});
  final String title;
  @override
  State<MechSem3Sub3> createState() => _MechSem3Sub3();
}

class _MechSem3Sub3 extends State<MechSem3Sub3> {
  bool semester = false;
  @override
