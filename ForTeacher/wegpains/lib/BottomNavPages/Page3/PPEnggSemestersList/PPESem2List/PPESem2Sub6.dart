...
class PPESem2Sub6 extends StatefulWidget {
  const PPESem2Sub6({key, required this.title});
  final String title;
  @override
  State<PPESem2Sub6> createState() => _PPESem2Sub6();
}

class _PPESem2Sub6 extends State<PPESem2Sub6> {
  bool semester = false;
  @override
