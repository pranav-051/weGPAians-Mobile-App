...
class PPESem1Sub2 extends StatefulWidget {
  const PPESem1Sub2({key, required this.title});
  final String title;
  @override
  State<PPESem1Sub2> createState() => _PPESem1Sub2();
}

class _PPESem1Sub2 extends State<PPESem1Sub2> {
  bool semester = false;
  @override
