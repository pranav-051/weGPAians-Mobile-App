...
class PPESem4Sub2 extends StatefulWidget {
  const PPESem4Sub2({key, required this.title});
  final String title;
  @override
  State<PPESem4Sub2> createState() => _PPESem4Sub2();
}

class _PPESem4Sub2 extends State<PPESem4Sub2> {
  bool semester = false;
  @override
