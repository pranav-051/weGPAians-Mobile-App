...
class CivilSem4Sub5 extends StatefulWidget {
  const CivilSem4Sub5({key, required this.title});
  final String title;
  @override
  State<CivilSem4Sub5> createState() => _CivilSem4Sub5();
}

class _CivilSem4Sub5 extends State<CivilSem4Sub5> {
  bool semester = false;
  @override
