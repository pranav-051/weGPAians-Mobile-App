...
class CivilSem4Sub4 extends StatefulWidget {
  const CivilSem4Sub4({key, required this.title});
  final String title;
  @override
  State<CivilSem4Sub4> createState() => _CivilSem4Sub4();
}

class _CivilSem4Sub4 extends State<CivilSem4Sub4> {
  bool semester = false;
  @override
