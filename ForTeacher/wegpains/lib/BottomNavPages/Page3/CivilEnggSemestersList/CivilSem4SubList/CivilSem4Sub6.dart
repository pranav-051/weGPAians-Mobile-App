...
class CivilSem4Sub6 extends StatefulWidget {
  const CivilSem4Sub6({key, required this.title});
  final String title;
  @override
  State<CivilSem4Sub6> createState() => _CivilSem4Sub6();
}

class _CivilSem4Sub6 extends State<CivilSem4Sub6> {
  bool semester = false;
  @override
