...
class CivilSem3Sub5 extends StatefulWidget {
  const CivilSem3Sub5({key, required this.title});
  final String title;
  @override
  State<CivilSem3Sub5> createState() => _CivilSem3Sub5();
}

class _CivilSem3Sub5 extends State<CivilSem3Sub5> {
  bool semester = false;
  @override
