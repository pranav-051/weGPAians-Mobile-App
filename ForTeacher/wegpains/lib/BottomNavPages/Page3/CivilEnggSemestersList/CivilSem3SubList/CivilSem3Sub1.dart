...
class CivilSem3Sub1 extends StatefulWidget {
  const CivilSem3Sub1({key, required this.title});
  final String title;
  @override
  State<CivilSem3Sub1> createState() => _CivilSem3Sub1();
}

class _CivilSem3Sub1 extends State<CivilSem3Sub1> {
  bool semester = false;
  @override
