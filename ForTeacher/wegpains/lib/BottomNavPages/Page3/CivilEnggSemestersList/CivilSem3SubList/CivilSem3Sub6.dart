...
class CivilSem3Sub6 extends StatefulWidget {
  const CivilSem3Sub6({key, required this.title});
  final String title;
  @override
  State<CivilSem3Sub6> createState() => _CivilSem3Sub6();
}

class _CivilSem3Sub6 extends State<CivilSem3Sub6> {
  bool semester = false;
  @override
