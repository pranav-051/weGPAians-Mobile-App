...
class CivilSem5Sub5 extends StatefulWidget {
  const CivilSem5Sub5({key, required this.title});
  final String title;
  @override
  State<CivilSem5Sub5> createState() => _CivilSem5Sub5();
}

class _CivilSem5Sub5 extends State<CivilSem5Sub5> {
  bool semester = false;
  @override
