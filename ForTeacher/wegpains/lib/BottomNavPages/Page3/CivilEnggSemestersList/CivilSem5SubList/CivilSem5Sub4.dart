...
class CivilSem5Sub4 extends StatefulWidget {
  const CivilSem5Sub4({key, required this.title});
  final String title;
  @override
  State<CivilSem5Sub4> createState() => _CivilSem5Sub4();
}

class _CivilSem5Sub4 extends State<CivilSem5Sub4> {
  bool semester = false;
  @override
