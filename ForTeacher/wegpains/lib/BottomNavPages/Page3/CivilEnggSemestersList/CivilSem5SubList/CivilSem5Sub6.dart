...
class CivilSem5Sub6 extends StatefulWidget {
  const CivilSem5Sub6({key, required this.title});
  final String title;
  @override
  State<CivilSem5Sub6> createState() => _CivilSem5Sub6();
}

class _CivilSem5Sub6 extends State<CivilSem5Sub6> {
  bool semester = false;
  @override
