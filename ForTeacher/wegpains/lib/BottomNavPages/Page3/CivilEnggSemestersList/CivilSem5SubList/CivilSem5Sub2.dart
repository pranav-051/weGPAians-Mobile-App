...
class CivilSem5Sub2 extends StatefulWidget {
  const CivilSem5Sub2({key, required this.title});
  final String title;
  @override
  State<CivilSem5Sub2> createState() => _CivilSem5Sub2();
}

class _CivilSem5Sub2 extends State<CivilSem5Sub2> {
  bool semester = false;
  @override
