...
class CivilSem2Sub4 extends StatefulWidget {
  const CivilSem2Sub4({key, required this.title});
  final String title;
  @override
  State<CivilSem2Sub4> createState() => _CivilSem2Sub4();
}

class _CivilSem2Sub4 extends State<CivilSem2Sub4> {
  bool semester = false;
  @override
