...
class CivilSem2Sub2 extends StatefulWidget {
  const CivilSem2Sub2({key, required this.title});
  final String title;
  @override
  State<CivilSem2Sub2> createState() => _CivilSem2Sub2();
}

class _CivilSem2Sub2 extends State<CivilSem2Sub2> {
  bool semester = false;
  @override
