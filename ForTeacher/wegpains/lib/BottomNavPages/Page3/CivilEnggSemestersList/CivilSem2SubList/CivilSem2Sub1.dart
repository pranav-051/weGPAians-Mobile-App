...
class CivilSem2Sub1 extends StatefulWidget {
  const CivilSem2Sub1({key, required this.title});
  final String title;
  @override
  State<CivilSem2Sub1> createState() => _CivilSem2Sub1();
}

class _CivilSem2Sub1 extends State<CivilSem2Sub1> {
  bool semester = false;
  @override
