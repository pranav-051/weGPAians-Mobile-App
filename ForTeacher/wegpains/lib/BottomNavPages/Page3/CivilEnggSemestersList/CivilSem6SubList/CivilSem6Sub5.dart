...
class CivilSem6Sub5 extends StatefulWidget {
  const CivilSem6Sub5({key, required this.title});
  final String title;
  @override
  State<CivilSem6Sub5> createState() => _CivilSem6Sub5();
}

class _CivilSem6Sub5 extends State<CivilSem6Sub5> {
  bool semester = false;
  @override
