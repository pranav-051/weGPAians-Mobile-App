...
class CivilSem6Sub3 extends StatefulWidget {
  const CivilSem6Sub3({key, required this.title});
  final String title;
  @override
  State<CivilSem6Sub3> createState() => _CivilSem6Sub3();
}

class _CivilSem6Sub3 extends State<CivilSem6Sub3> {
  bool semester = false;
  @override
