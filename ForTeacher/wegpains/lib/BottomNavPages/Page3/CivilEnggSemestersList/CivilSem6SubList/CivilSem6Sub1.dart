...
class CivilSem6Sub1 extends StatefulWidget {
  const CivilSem6Sub1({key, required this.title});
  final String title;
  @override
  State<CivilSem6Sub1> createState() => _CivilSem6Sub1();
}

class _CivilSem6Sub1 extends State<CivilSem6Sub1> {
  bool semester = false;
  @override
