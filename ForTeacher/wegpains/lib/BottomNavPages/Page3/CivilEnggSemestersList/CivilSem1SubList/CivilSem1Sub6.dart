...
class CivilSem1Sub6 extends StatefulWidget {
  const CivilSem1Sub6({key, required this.title});
  final String title;
  @override
  State<CivilSem1Sub6> createState() => _CivilSem1Sub6();
}

class _CivilSem1Sub6 extends State<CivilSem1Sub6> {
  bool semester = false;
  @override
