...
class CivilSem1Sub3 extends StatefulWidget {
  const CivilSem1Sub3({key, required this.title});
  final String title;
  @override
  State<CivilSem1Sub3> createState() => _CivilSem1Sub3();
}

class _CivilSem1Sub3 extends State<CivilSem1Sub3> {
  bool semester = false;
  @override
