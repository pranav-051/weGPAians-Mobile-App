...
class CivilSem1Sub1 extends StatefulWidget {
  const CivilSem1Sub1({key, required this.title});
  final String title;
  @override
  State<CivilSem1Sub1> createState() => _CivilSem1Sub1();
}

class _CivilSem1Sub1 extends State<CivilSem1Sub1> {
  bool semester = false;
  @override
