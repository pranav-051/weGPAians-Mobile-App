...
class ETXSem3Sub6 extends StatefulWidget {
  const ETXSem3Sub6({key, required this.title});
  final String title;
  @override
  State<ETXSem3Sub6> createState() => _ETXSem3Sub6();
}

class _ETXSem3Sub6 extends State<ETXSem3Sub6> {
  bool semester = false;
  @override
