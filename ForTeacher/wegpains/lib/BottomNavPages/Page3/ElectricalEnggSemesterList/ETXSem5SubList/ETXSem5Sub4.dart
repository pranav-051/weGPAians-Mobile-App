...
class ETXSem5Sub4 extends StatefulWidget {
  const ETXSem5Sub4({key, required this.title});
  final String title;
  @override
  State<ETXSem5Sub4> createState() => _ETXSem5Sub4();
}

class _ETXSem5Sub4 extends State<ETXSem5Sub4> {
  bool semester = false;
  @override
