...
class ETXSem5Sub3 extends StatefulWidget {
  const ETXSem5Sub3({key, required this.title});
  final String title;
  @override
  State<ETXSem5Sub3> createState() => _ETXSem5Sub3();
}

class _ETXSem5Sub3 extends State<ETXSem5Sub3> {
  bool semester = false;
  @override
