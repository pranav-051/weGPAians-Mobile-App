...
class ETXSem5Sub1 extends StatefulWidget {
  const ETXSem5Sub1({key, required this.title});
  final String title;
  @override
  State<ETXSem5Sub1> createState() => _ETXSem5Sub1();
}

class _ETXSem5Sub1 extends State<ETXSem5Sub1> {
  bool semester = false;
  @override
