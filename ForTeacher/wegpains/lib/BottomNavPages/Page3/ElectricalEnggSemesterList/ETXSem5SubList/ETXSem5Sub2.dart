...
class ETXSem5Sub2 extends StatefulWidget {
  const ETXSem5Sub2({key, required this.title});
  final String title;
  @override
  State<ETXSem5Sub2> createState() => _ETXSem5Sub2();
}

class _ETXSem5Sub2 extends State<ETXSem5Sub2> {
  bool semester = false;
  @override
