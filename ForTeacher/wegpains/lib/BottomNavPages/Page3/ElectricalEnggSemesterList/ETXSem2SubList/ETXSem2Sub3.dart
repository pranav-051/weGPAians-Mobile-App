...
class ETXSem2Sub3 extends StatefulWidget {
  const ETXSem2Sub3({key, required this.title});
  final String title;
  @override
  State<ETXSem2Sub3> createState() => _ETXSem2Sub3();
}

class _ETXSem2Sub3 extends State<ETXSem2Sub3> {
  bool semester = false;
  @override
