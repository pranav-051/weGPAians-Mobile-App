...
class ETXSem2Sub4 extends StatefulWidget {
  const ETXSem2Sub4({key, required this.title});
  final String title;
  @override
  State<ETXSem2Sub4> createState() => _ETXSem2Sub4();
}

class _ETXSem2Sub4 extends State<ETXSem2Sub4> {
  bool semester = false;
  @override
