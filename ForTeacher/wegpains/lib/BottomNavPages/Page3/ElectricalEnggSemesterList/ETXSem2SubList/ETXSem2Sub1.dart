...
class ETXSem2Sub1 extends StatefulWidget {
  const ETXSem2Sub1({key, required this.title});
  final String title;
  @override
  State<ETXSem2Sub1> createState() => _ETXSem2Sub1();
}

class _ETXSem2Sub1 extends State<ETXSem2Sub1> {
  bool semester = false;
  @override
