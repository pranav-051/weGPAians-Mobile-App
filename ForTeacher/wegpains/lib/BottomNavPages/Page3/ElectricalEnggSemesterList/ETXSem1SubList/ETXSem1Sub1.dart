...
class ETXSem1Sub1 extends StatefulWidget {
  const ETXSem1Sub1({key, required this.title});
  final String title;
  @override
  State<ETXSem1Sub1> createState() => _ETXSem1Sub1();
}

class _ETXSem1Sub1 extends State<ETXSem1Sub1> {
  bool semester = false;
  @override
