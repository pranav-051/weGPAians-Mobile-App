...
class ETXSem1Sub3 extends StatefulWidget {
  const ETXSem1Sub3({key, required this.title});
  final String title;
  @override
  State<ETXSem1Sub3> createState() => _ETXSem1Sub3();
}

class _ETXSem1Sub3 extends State<ETXSem1Sub3> {
  bool semester = false;
  @override
