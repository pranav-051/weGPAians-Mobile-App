...
class ETXSem1Sub4 extends StatefulWidget {
  const ETXSem1Sub4({key, required this.title});
  final String title;
  @override
  State<ETXSem1Sub4> createState() => _ETXSem1Sub4();
}

class _ETXSem1Sub4 extends State<ETXSem1Sub4> {
  bool semester = false;
  @override
