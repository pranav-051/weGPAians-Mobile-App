...
class ETXSem1Sub2 extends StatefulWidget {
  const ETXSem1Sub2({key, required this.title});
  final String title;
  @override
  State<ETXSem1Sub2> createState() => _ETXSem1Sub2();
}

class _ETXSem1Sub2 extends State<ETXSem1Sub2> {
  bool semester = false;
  @override
