...
class ETXSem1Sub6 extends StatefulWidget {
  const ETXSem1Sub6({key, required this.title});
  final String title;
  @override
  State<ETXSem1Sub6> createState() => _ETXSem1Sub6();
}

class _ETXSem1Sub6 extends State<ETXSem1Sub6> {
  bool semester = false;
  @override
