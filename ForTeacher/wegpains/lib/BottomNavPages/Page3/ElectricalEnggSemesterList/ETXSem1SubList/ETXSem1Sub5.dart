...
class ETXSem1Sub5 extends StatefulWidget {
  const ETXSem1Sub5({key, required this.title});
  final String title;
  @override
  State<ETXSem1Sub5> createState() => _ETXSem1Sub5();
}

class _ETXSem1Sub5 extends State<ETXSem1Sub5> {
  bool semester = false;
  @override
