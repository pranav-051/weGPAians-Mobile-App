...
class ETXSem4Sub5 extends StatefulWidget {
  const ETXSem4Sub5({key, required this.title});
  final String title;
  @override
  State<ETXSem4Sub5> createState() => _ETXSem4Sub5();
}

class _ETXSem4Sub5 extends State<ETXSem4Sub5> {
  bool semester = false;
  @override
