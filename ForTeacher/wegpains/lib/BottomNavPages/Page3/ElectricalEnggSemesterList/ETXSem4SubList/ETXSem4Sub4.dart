...
class ETXSem4Sub4 extends StatefulWidget {
  const ETXSem4Sub4({key, required this.title});
  final String title;
  @override
  State<ETXSem4Sub4> createState() => _ETXSem4Sub4();
}

class _ETXSem4Sub4 extends State<ETXSem4Sub4> {
  bool semester = false;
  @override
