...
class ETXSem4Sub2 extends StatefulWidget {
  const ETXSem4Sub2({key, required this.title});
  final String title;
  @override
  State<ETXSem4Sub2> createState() => _ETXSem4Sub2();
}

class _ETXSem4Sub2 extends State<ETXSem4Sub2> {
  bool semester = false;
  @override
