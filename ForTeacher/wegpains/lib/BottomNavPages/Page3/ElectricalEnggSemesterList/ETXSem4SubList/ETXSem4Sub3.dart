...
class ETXSem4Sub3 extends StatefulWidget {
  const ETXSem4Sub3({key, required this.title});
  final String title;
  @override
  State<ETXSem4Sub3> createState() => _ETXSem4Sub3();
}

class _ETXSem4Sub3 extends State<ETXSem4Sub3> {
  bool semester = false;
  @override
