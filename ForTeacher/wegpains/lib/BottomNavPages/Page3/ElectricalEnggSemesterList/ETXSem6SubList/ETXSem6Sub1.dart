...
class ETXSem6Sub1 extends StatefulWidget {
  const ETXSem6Sub1({key, required this.title});
  final String title;
  @override
  State<ETXSem6Sub1> createState() => _ETXSem6Sub1();
}

class _ETXSem6Sub1 extends State<ETXSem6Sub1> {
  bool semester = false;
  @override
