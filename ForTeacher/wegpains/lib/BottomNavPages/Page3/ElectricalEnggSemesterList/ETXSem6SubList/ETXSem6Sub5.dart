...
class ETXSem6Sub5 extends StatefulWidget {
  const ETXSem6Sub5({key, required this.title});
  final String title;
  @override
  State<ETXSem6Sub5> createState() => _ETXSem6Sub5();
}

class _ETXSem6Sub5 extends State<ETXSem6Sub5> {
  bool semester = false;
  @override
