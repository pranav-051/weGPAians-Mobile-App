...
class ETXSem6Sub2 extends StatefulWidget {
  const ETXSem6Sub2({key, required this.title});
  final String title;
  @override
  State<ETXSem6Sub2> createState() => _ETXSem6Sub2();
}

class _ETXSem6Sub2 extends State<ETXSem6Sub2> {
  bool semester = false;
  @override
