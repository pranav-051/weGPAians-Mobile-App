...
class ETXSem6Sub4 extends StatefulWidget {
  const ETXSem6Sub4({key, required this.title});
  final String title;
  @override
  State<ETXSem6Sub4> createState() => _ETXSem6Sub4();
}

class _ETXSem6Sub4 extends State<ETXSem6Sub4> {
  bool semester = false;
  @override
