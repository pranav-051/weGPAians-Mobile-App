...
class ChemSem1Sub2 extends StatefulWidget {
  const ChemSem1Sub2({key, required this.title});
  final String title;
  @override
  State<ChemSem1Sub2> createState() => _ChemSem1Sub2();
}

class _ChemSem1Sub2 extends State<ChemSem1Sub2> {
  bool semester = false;
  @override
