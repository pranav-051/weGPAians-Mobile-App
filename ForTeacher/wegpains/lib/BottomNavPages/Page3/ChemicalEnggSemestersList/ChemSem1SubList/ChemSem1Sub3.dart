...
class ChemSem1Sub3 extends StatefulWidget {
  const ChemSem1Sub3({key, required this.title});
  final String title;
  @override
  State<ChemSem1Sub3> createState() => _ChemSem1Sub3();
}

class _ChemSem1Sub3 extends State<ChemSem1Sub3> {
  bool semester = false;
  @override
