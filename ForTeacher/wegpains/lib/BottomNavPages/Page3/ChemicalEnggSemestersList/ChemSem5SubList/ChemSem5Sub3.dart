...
class ChemSem5Sub3 extends StatefulWidget {
  const ChemSem5Sub3({key, required this.title});
  final String title;
  @override
  State<ChemSem5Sub3> createState() => _ChemSem5Sub3();
}

class _ChemSem5Sub3 extends State<ChemSem5Sub3> {
  bool semester = false;
  @override
