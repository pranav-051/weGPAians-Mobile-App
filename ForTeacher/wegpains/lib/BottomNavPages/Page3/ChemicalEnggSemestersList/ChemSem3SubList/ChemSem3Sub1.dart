...
class ChemSem3Sub1 extends StatefulWidget {
  const ChemSem3Sub1({key, required this.title});
  final String title;
  @override
  State<ChemSem3Sub1> createState() => _ChemSem3Sub1();
}

class _ChemSem3Sub1 extends State<ChemSem3Sub1> {
  bool semester = false;
  @override
