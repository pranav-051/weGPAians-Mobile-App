...
class ChemSem3Sub6 extends StatefulWidget {
  const ChemSem3Sub6({key, required this.title});
  final String title;
  @override
  State<ChemSem3Sub6> createState() => _ChemSem3Sub6();
}

class _ChemSem3Sub6 extends State<ChemSem3Sub6> {
  bool semester = false;
  @override
