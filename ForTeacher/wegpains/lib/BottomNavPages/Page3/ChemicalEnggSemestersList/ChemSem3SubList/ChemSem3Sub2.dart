...
class ChemSem3Sub2 extends StatefulWidget {
  const ChemSem3Sub2({key, required this.title});
  final String title;
  @override
  State<ChemSem3Sub2> createState() => _ChemSem3Sub2();
}

class _ChemSem3Sub2 extends State<ChemSem3Sub2> {
  bool semester = false;
  @override
