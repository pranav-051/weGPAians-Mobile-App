...
class ChemSem6Sub3 extends StatefulWidget {
  const ChemSem6Sub3({key, required this.title});
  final String title;
  @override
  State<ChemSem6Sub3> createState() => _ChemSem6Sub3();
}

class _ChemSem6Sub3 extends State<ChemSem6Sub3> {
  bool semester = false;
  @override
