...
class ChemSem6Sub2 extends StatefulWidget {
  const ChemSem6Sub2({key, required this.title});
  final String title;
  @override
  State<ChemSem6Sub2> createState() => _ChemSem6Sub2();
}

class _ChemSem6Sub2 extends State<ChemSem6Sub2> {
  bool semester = false;
  @override
