...
class ChemSem6Sub5 extends StatefulWidget {
  const ChemSem6Sub5({key, required this.title});
  final String title;
  @override
  State<ChemSem6Sub5> createState() => _ChemSem6Sub5();
}

class _ChemSem6Sub5 extends State<ChemSem6Sub5> {
  bool semester = false;
  @override
