...
class ChemSem6Sub6 extends StatefulWidget {
  const ChemSem6Sub6({key, required this.title});
  final String title;
  @override
  State<ChemSem6Sub6> createState() => _ChemSem6Sub6();
}

class _ChemSem6Sub6 extends State<ChemSem6Sub6> {
  bool semester = false;
  @override
