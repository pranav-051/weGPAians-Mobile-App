...
class ChemSem2Sub3 extends StatefulWidget {
  const ChemSem2Sub3({key, required this.title});
  final String title;
  @override
  State<ChemSem2Sub3> createState() => _ChemSem2Sub3();
}

class _ChemSem2Sub3 extends State<ChemSem2Sub3> {
  bool semester = false;
  @override
