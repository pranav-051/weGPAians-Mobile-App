...
class CSESem1Sub1MP extends StatefulWidget{
  const CSESem1Sub1MP({Key?key}) : super(key : key);
  @override
  _CSESem1Sub1MP createState() => _CSESem1Sub1MP();
}

class _CSESem1Sub1MP extends State<CSESem1Sub1MP>{
  //++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
  ...
  uploadDataToFirebase() async{
    ...
    //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    var CSESem1Sub1MP = pick.readAsBytesSync();
    //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    ...
    //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    UploadTask task = pdffile.putData(CSESem1Sub1MP);
    //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    ...
    //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    await FirebaseFirestore.instance.collection("CSESem1Sub1MP").doc().set({
      //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++

      'fileUrl': url,
      'num': "Microproject Format#$number"
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        iconTheme: const IconThemeData(
            color: Colors.white),
        title: const Text("   Microproject Format", style: TextStyle(color: Colors.white),),
      ),
      body: StreamBuilder(

        //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
        stream: FirebaseFirestore.instance.collection("CSESem1Sub1MP").snapshots(),
        //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
