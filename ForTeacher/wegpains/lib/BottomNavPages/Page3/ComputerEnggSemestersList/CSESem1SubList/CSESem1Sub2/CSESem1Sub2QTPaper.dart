...
class CSESem1Sub2QTPaper extends StatefulWidget{
  const CSESem1Sub2QTPaper({Key?key}) : super(key : key);
  @override
  _CSESem1Sub2QTPaper createState() => _CSESem1Sub2QTPaper();
}

class _CSESem1Sub2QTPaper extends State<CSESem1Sub2QTPaper>{
  //++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
  ...
  uploadDataToFirebase() async{
    ...
    //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    var CSESem1Sub2QTPaper = pick.readAsBytesSync();
    //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    ...
    //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    UploadTask task = pdffile.putData(CSESem1Sub2QTPaper);
    //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    ...
    //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    await FirebaseFirestore.instance.collection("CSESem1Sub2QTPaper").doc().set({
      //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++

      'fileUrl': url,
      'num': "sample question paper#$number"
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        iconTheme: const IconThemeData(
            color: Colors.white),
        title: const Text("   [CC1402] Basic Physics", style: TextStyle(color: Colors.white),),
      ),
      body: StreamBuilder(

        //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
        stream: FirebaseFirestore.instance.collection("CSESem1Sub2QTPaper").snapshots(),
        //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
