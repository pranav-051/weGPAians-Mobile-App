...
class CSESem1Sub6SPrac extends StatefulWidget{
  const CSESem1Sub6SPrac({Key?key}) : super(key : key);
  @override
  _CSESem1Sub6SPrac createState() => _CSESem1Sub6SPrac();
}

class _CSESem1Sub6SPrac extends State<CSESem1Sub6SPrac>{
  //++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
  ...
  uploadDataToFirebase() async{
    ...
    //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    var CSESem1Sub6SPrac = pick.readAsBytesSync();
    //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    ...
    //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    UploadTask task = pdffile.putData(CSESem1Sub6SPrac);
    //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    ...
    //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    await FirebaseFirestore.instance.collection("CSESem1Sub6SPrac").doc().set({
      //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
  ...
  Widget build (BuildContext context) {
    return Scaffold(
      ...
      body: StreamBuilder(
        ...
        //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
        stream: FirebaseFirestore.instance.collection("CSESem1Sub6SPrac").snapshots(),
        //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
