...
import 'CSESem1Sub3/CSESem1Sub3Curr.dart';
import 'CSESem1Sub3/CSESem1Sub3QTPaper.dart';
import 'CSESem1Sub3/CSESem1Sub3QTPaperFormat.dart';
import 'CSESem1Sub3/CSESem1Sub3Utube.dart';
import 'CSESem1Sub3/CSESem1Sub3ebooks.dart';

class CSESem1Sub3 extends StatefulWidget {
  const CSESem1Sub3 ({Key? key, required this.title}) : super(key: key);
  final String title;
  @override
  State<CSESem1Sub3> createState() => _CSESem1Sub3();
}

class _CSESem1Sub3 extends State<CSESem1Sub3> {
  bool semester = false;
  @override
                ...
                child: Card(
                    ...
                    child: InkWell(
                        onLongPress: () => {
                          Navigator.push(
                            context,
                            MaterialPageRoute(builder: (context) =>  const CSESem1Sub3Curr()),
                          )
                        },
                        child: Container(
                ...
                child: Card(
                    ...
                    child: InkWell(
                        onLongPress: () => {
                          Navigator.push(
                            context,
                            MaterialPageRoute(builder: (context) =>  const CSESem1Sub3ebooks()),
                          )
                        },
                        child: Container(
                            decoration: const BoxDecoration(
                    ...
                    child: InkWell(
                        onLongPress: () => {
                          Navigator.push(
                            ...
                            MaterialPageRoute(
                                builder: (context) =>
                                const CSESem1Sub3Utube(title: 'web',)),
                          )
                        },
                        child: Container(
                            decoration: const BoxDecoration(
                ...
                child: Card(
                    ...
                    child: InkWell(
                        onLongPress: () => {
                          Navigator.push(
                            context,
                            MaterialPageRoute(builder: (context) =>  const CSESem1Sub3QTPaper()),
                          )
                        },
                        child: Container(
                            decoration: const BoxDecoration(
                ...
                child: Card(
                    ...
                    child: InkWell(
                        onLongPress: () => {
                          Navigator.push(
                            context,
                            MaterialPageRoute(builder: (context) =>  const CSESem1Sub3QTPaperFormat()),
                          )
                        },
                        child: Container(
                            decoration: const BoxDecoration(
