...
class CSESem1Sub7Curr extends StatefulWidget{
  const CSESem1Sub7Curr({Key?key}) : super(key : key);
  @override
  _CSESem1Sub7Curr createState() => _CSESem1Sub7Curr();
}

class _CSESem1Sub7Curr extends State<CSESem1Sub7Curr>{
  //++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
  ...
  uploadDataToFirebase() async{
    ...
    //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    var CSESem1Sub7Curr = pick.readAsBytesSync();
    //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    ...
    //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    UploadTask task = pdffile.putData(CSESem1Sub7Curr);
    //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    ...
    //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    await FirebaseFirestore.instance.collection("CSESem1Sub7Curr").doc().set({
    //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
  ...
  Widget build (BuildContext context) {
    return Scaffold(
      ...
      body: StreamBuilder(
        ...
        //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
        stream: FirebaseFirestore.instance.collection("CSESem1Sub7Curr").snapshots(),
        //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
                              ...
                              child:  Column(
                                ...
                                children: <Widget>[
                                  ...
                                  ListTile(
                                    ...
                                    title: const Text(
                                      "[CM2403] Computer Workshops Practices",
