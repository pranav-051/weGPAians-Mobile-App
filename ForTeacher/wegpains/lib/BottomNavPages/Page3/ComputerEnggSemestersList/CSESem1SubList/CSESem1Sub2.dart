...
import 'CSESem1Sub2/CSESem1Sub2Curr.dart';
import 'CSESem1Sub2/CSESem1Sub2QTPaper.dart';
import 'CSESem1Sub2/CSESem1Sub2QTPaperFormat.dart';
import 'CSESem1Sub2/CSESem1Sub2ebooks.dart';
import 'CSESem1Sub2/CSESem2Utube.dart';

class CSESem1Sub2 extends StatefulWidget {
  const CSESem1Sub2 ({Key? key, required this.title}) : super(key: key);
  final String title;
  @override
  State<CSESem1Sub2> createState() => _CSESem1Sub2();
}

class _CSESem1Sub2 extends State<CSESem1Sub2> {
  bool semester = false;
  @override
                ...
                child: Card(
                    ...
                    child: InkWell(
                        onLongPress: () => {
                          Navigator.push(
                            context,
                            MaterialPageRoute(builder: (context) =>  const CSESem1Sub2Curr()),
                          )
                        },
                        child: Container(
                ...
                child: Card(
                    ...
                    child: InkWell(
                        onLongPress: () => {
                          Navigator.push(
                            context,
                            MaterialPageRoute(builder: (context) =>  const CSESem1Sub2ebooks()),
                          )
                        },
                        child: Container(
                            decoration: const BoxDecoration(
                    ...
                    child: InkWell(
                        onLongPress: () => {
                          Navigator.push(
                            ...
                            MaterialPageRoute(
                                builder: (context) =>
                                const CSESem1Sub2Utube(title: 'web',)),
                          )
                        },
                        child: Container(
                            decoration: const BoxDecoration(
                ...
                child: Card(
                    ...
                    child: InkWell(
                        onLongPress: () => {
                          Navigator.push(
                            context,
                            MaterialPageRoute(builder: (context) =>  const CSESem1Sub2QTPaper()),
                          )
                        },
                        child: Container(
                            decoration: const BoxDecoration(
                ...
                child: Card(
                    ...
                    child: InkWell(
                        onLongPress: () => {
                          Navigator.push(
                            context,
                            MaterialPageRoute(builder: (context) =>  const CSESem1Sub2QTPaperFormat()),
                          )
                        },
                        child: Container(
                            decoration: const BoxDecoration(
