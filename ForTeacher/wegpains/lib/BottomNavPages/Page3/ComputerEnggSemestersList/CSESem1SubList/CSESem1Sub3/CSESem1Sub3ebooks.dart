...
class CSESem1Sub3ebooks extends StatefulWidget{
  const CSESem1Sub3ebooks({Key?key}) : super(key : key);
  @override
  _CSESem1Sub3ebooks createState() => _CSESem1Sub3ebooks();
}

class _CSESem1Sub3ebooks extends State<CSESem1Sub3ebooks>{
  //++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
  ...
  uploadDataToFirebase() async{
    ...
    //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    var CSESem1Sub3ebooks = pick.readAsBytesSync();
    //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    ...
    //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    UploadTask task = pdffile.putData(CSESem1Sub3ebooks);
    //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    ...
    //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    await FirebaseFirestore.instance.collection("CSESem1Sub3ebooks").doc().set({
      //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        iconTheme: const IconThemeData(
            color: Colors.white),
        title: const Text("[CC1401] English", style: TextStyle(color: Colors.white),),
      ),
      body: StreamBuilder(

        //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
        stream: FirebaseFirestore.instance.collection("CSESem1Sub3ebooks").snapshots(),
        //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
