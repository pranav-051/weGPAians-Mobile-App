...
import 'package:untitled/BottomNavPages/Page3/ComputerEnggSemestersList/CSESem1SubList/CSESem1Sub1/CSESem1Sub1Utube.dart';
import 'CSESem1Sub1/CSESem1Sub1Curr.dart';
import 'CSESem1Sub1/CSESem1Sub1MP.dart';
import 'CSESem1Sub1/CSESem1Sub1QTPaper.dart';
import 'CSESem1Sub1/CSESem1Sub1QTPaperFormat.dart';
import 'CSESem1Sub1/CSESem1Sub1SPrac.dart';
import 'CSESem1Sub1/CSESem1Sub1ebooks.dart';
import 'CSESem1Sub1/CSESem1Sub1websites.dart';

class CSESem1Sub1 extends StatefulWidget {
  const CSESem1Sub1({Key? key, required this.title}) : super(key: key);
  final String title;
  @override
  State<CSESem1Sub1> createState() => _CSESem1Sub1();
}

class _CSESem1Sub1 extends State<CSESem1Sub1> {
  bool semester = false;
  @override
                    ...
                    child: InkWell(
                        onLongPress: () => {
                              Navigator.push(
                                ...
                                MaterialPageRoute(
                                    builder: (context) =>
                                        const CSESem1Sub1QTPaperFormat()),
                              )
                            },
                        child: Container(
                            decoration: const BoxDecoration(
