...
import '../CSESem1SubList/CSESem1Sub1/CSESem1Sub1SPrac.dart';
import '../CSESem1SubList/CSESem1Sub1/CSESem1Sub1websites.dart';
import 'CSESem2Sub1/CSESem2Sub1Utube.dart';
import 'CSESem2Sub2/CSESem2Sub2Curr.dart';
import 'CSESem2Sub2/CSESem2Sub2MP.dart';
import 'CSESem2Sub2/CSESem2Sub2QTPaper.dart';
import 'CSESem2Sub2/CSESem2Sub2QTPaperFormat.dart';
import 'CSESem2Sub2/CSESem2Sub2ebooks.dart';

class CSESem2Sub2 extends StatefulWidget {
  const CSESem2Sub2 ({Key? key, required this.title}) : super(key: key);
  final String title;
  @override
  State<CSESem2Sub2> createState() => _CSESem2Sub2();
}

class _CSESem2Sub2 extends State<CSESem2Sub2> {
  bool semester = false;
  @override
                ...
                child: Card(
                    ...
                    child: InkWell(
                        onLongPress: () => {
                          Navigator.push(
                            context,
                            MaterialPageRoute(builder: (context) =>  const CSESem2Sub2Curr()),
                          )
                        },
                        child: Container(
                ...
                child: Card(
                    ...
                    child: InkWell(
                        onLongPress: () => {
                          Navigator.push(
                            context,
                            MaterialPageRoute(builder: (context) =>  const CSESem2Sub2ebooks()),
                          )
                        },
                        child: Container(
                            decoration: const BoxDecoration(
                    ...
                    child: InkWell(
                        onLongPress: () => {
                          Navigator.push(
                            ...
                            MaterialPageRoute(
                                builder: (context) =>
                                const CSESem2Sub1Utube(title: 'web',)),
                          )
                        },
                        child: Container(
                            decoration: const BoxDecoration(
                ...
                child: Card(
                    ...
                    child: InkWell(
                        onLongPress: () => {
                          Navigator.push(
                            context,
                            MaterialPageRoute(builder: (context) =>  const CSESem2Sub2QTPaper()),
                          )
                        },
                        child: Container(
                            decoration: const BoxDecoration(
                ...
                child: Card(
                    ...
                    child: InkWell(
                        onLongPress: () => {
                          Navigator.push(
                            context,
                            MaterialPageRoute(builder: (context) =>  const CSESem2Sub2QTPaperFormat()),
                          )
                        },
                        child: Container(
                            decoration: const BoxDecoration(
