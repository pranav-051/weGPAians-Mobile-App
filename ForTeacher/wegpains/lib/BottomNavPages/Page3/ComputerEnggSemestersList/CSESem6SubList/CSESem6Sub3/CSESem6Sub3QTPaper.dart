...
class CSESem6Sub3QTPaper extends StatefulWidget{
  const CSESem6Sub3QTPaper({Key?key}) : super(key : key);
  @override
  _CSESem6Sub3QTPaper createState() => _CSESem6Sub3QTPaper();
}

class _CSESem6Sub3QTPaper extends State<CSESem6Sub3QTPaper>{
  //++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
  ...
  uploadDataToFirebase() async{
    ...
    //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    var CSESem6Sub3QTPaper = pick.readAsBytesSync();
    //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    ...
    //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    UploadTask task = pdffile.putData(CSESem6Sub3QTPaper);
    //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    ...
    //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    await FirebaseFirestore.instance.collection("CSESem6Sub3QTPaper").doc().set({
      //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
  ...
  Widget build (BuildContext context) {
    return Scaffold(
      ...
      body: StreamBuilder(
        ...
        //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
        stream: FirebaseFirestore.instance.collection("CSESem6Sub3QTPaper").snapshots(),
        //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
