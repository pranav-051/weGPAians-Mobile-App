...
class CSESem6Sub6ebooks extends StatefulWidget{
  const CSESem6Sub6ebooks({Key?key}) : super(key : key);
  @override
  _CSESem6Sub6ebooks createState() => _CSESem6Sub6ebooks();
}

class _CSESem6Sub6ebooks extends State<CSESem6Sub6ebooks>{
  //++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
  ...
  uploadDataToFirebase() async{
    ...
    //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    var CSESem6Sub6ebooks = pick.readAsBytesSync();
    //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    ...
    //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    UploadTask task = pdffile.putData(CSESem6Sub6ebooks);
    //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    ...
    //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    await FirebaseFirestore.instance.collection("CSESem6Sub6ebooks").doc().set({
      //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
  ...
  Widget build (BuildContext context) {
    return Scaffold(
      ...
      body: StreamBuilder(
        ...
        //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
        stream: FirebaseFirestore.instance.collection("CSESem6Sub6ebooks").snapshots(),
        //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
