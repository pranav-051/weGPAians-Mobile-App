...
import 'CSESem3Sub5/CSESem3Sub5Curr.dart';
import 'CSESem3Sub5/CSESem3Sub5MP.dart';
import 'CSESem3Sub5/CSESem3Sub5QTPaper.dart';
import 'CSESem3Sub5/CSESem3Sub5QTPaperFormat.dart';
import 'CSESem3Sub5/CSESem3Sub5SPrac.dart';
import 'CSESem3Sub5/CSESem3Sub5Utube.dart';
import 'CSESem3Sub5/CSESem3Sub5ebooks.dart';


class CSESem3Sub5 extends StatefulWidget {
  const CSESem3Sub5 ({Key? key, required this.title}) : super(key: key);
  final String title;
  @override
  State<CSESem3Sub5> createState() => _CSESem3Sub5();
}

class _CSESem3Sub5 extends State<CSESem3Sub5> {
  bool semester = false;
  @override
                ...
                child: Card(
                    ...
                    child: InkWell(
                        onLongPress: () => {
                          Navigator.push(
                            context,
                            MaterialPageRoute(builder: (context) =>  const CSESem3Sub5Curr()),
                          )
                        },
                        child: Container(
                ...
                child: Card(
                    ...
                    child: InkWell(
                        onLongPress: () => {
                          Navigator.push(
                            context,
                            MaterialPageRoute(builder: (context) =>  const CSESem3Sub5ebooks()),
                          )
                        },
                        child: Container(
                            decoration: const BoxDecoration(
                    ...
                    child: InkWell(
                        onLongPress: () => {
                          Navigator.push(
                            ...
                            MaterialPageRoute(
                                builder: (context) =>
                                const CSESem3Sub5Utube(title: 'web',)),
                          )
                        },
                        child: Container(
                            decoration: const BoxDecoration(
                ...
                child: Card(
                    ...
                    child: InkWell(
                        onLongPress: () => {
                          Navigator.push(
                            context,
                            MaterialPageRoute(builder: (context) =>  const CSESem3Sub5QTPaper()),
                          )
                        },
                        child: Container(
                            decoration: const BoxDecoration(
                ...
                child: Card(
                    ...
                    child: InkWell(
                        onLongPress: () => {
                          Navigator.push(
                            context,
                            MaterialPageRoute(builder: (context) =>  const CSESem3Sub5QTPaperFormat()),
                          )
                        },
                        child: Container(
                            decoration: const BoxDecoration(
                ...
                child: Card(
                    ...
                    child: InkWell(
                        onLongPress: () => {
                          Navigator.push(
                            context,
                            MaterialPageRoute(builder: (context) =>  const CSESem3Sub5SPrac()),
                          )
                        },
                        child: Container(
                            decoration: const BoxDecoration(
