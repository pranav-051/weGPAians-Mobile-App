...
import 'CSESem3Sub3/CSESem3Sub3Curr.dart';
import 'CSESem3Sub3/CSESem3Sub3MP.dart';
import 'CSESem3Sub3/CSESem3Sub3QTPaper.dart';
import 'CSESem3Sub3/CSESem3Sub3QTPaperFormat.dart';
import 'CSESem3Sub3/CSESem3Sub3SPrac.dart';
import 'CSESem3Sub3/CSESem3Sub3Utube.dart';
import 'CSESem3Sub3/CSESem3Sub3ebooks.dart';



class CSESem3Sub3 extends StatefulWidget {
  const CSESem3Sub3 ({Key? key, required this.title}) : super(key: key);
  final String title;
  @override
  State<CSESem3Sub3> createState() => _CSESem3Sub3();
}

class _CSESem3Sub3 extends State<CSESem3Sub3> {
  bool semester = false;
  @override
                ...
                child: Card(
                    ...
                    child: InkWell(
                        onLongPress: () => {
                          Navigator.push(
                            context,
                            MaterialPageRoute(builder: (context) =>  const CSESem3Sub3Curr()),
                          )
                        },
                        child: Container(
                ...
                child: Card(
                    ...
                    child: InkWell(
                        onLongPress: () => {
                          Navigator.push(
                            context,
                            MaterialPageRoute(builder: (context) =>  const CSESem3Sub3ebooks()),
                          )
                        },
                        child: Container(
                            decoration: const BoxDecoration(
                    ...
                    child: InkWell(
                        onLongPress: () => {
                          Navigator.push(
                            ...
                            MaterialPageRoute(
                                builder: (context) =>
                                const CSESem3Sub3Utube(title: 'web',)),
                          )
                        },
                        child: Container(
                            decoration: const BoxDecoration(
                ...
                child: Card(
                    ...
                    child: InkWell(
                        onLongPress: () => {
                          Navigator.push(
                            context,
                            MaterialPageRoute(builder: (context) =>  const CSESem3Sub3QTPaper()),
                          )
                        },
                        child: Container(
                            decoration: const BoxDecoration(
                ...
                child: Card(
                    ...
                    child: InkWell(
                        onLongPress: () => {
                          Navigator.push(
                            context,
                            MaterialPageRoute(builder: (context) =>  const CSESem3Sub3QTPaperFormat()),
                          )
                        },
                        child: Container(
                            decoration: const BoxDecoration(
                ...
                child: Card(
                    ...
                    child: InkWell(
                        onLongPress: () => {
                          Navigator.push(
                            context,
                            MaterialPageRoute(builder: (context) =>  const CSESem3Sub3SPrac()),
                          )
                        },
                        child: Container(
                            decoration: const BoxDecoration(
