...
import 'CSESem3Sub4/CSESem3Sub4Curr.dart';
import 'CSESem3Sub4/CSESem3Sub4MP.dart';
import 'CSESem3Sub4/CSESem3Sub4QTPaper.dart';
import 'CSESem3Sub4/CSESem3Sub4QTPaperFormat.dart';
import 'CSESem3Sub4/CSESem3Sub4SPrac.dart';
import 'CSESem3Sub4/CSESem3Sub4Utube.dart';
import 'CSESem3Sub4/CSESem3Sub4ebooks.dart';

class CSESem3Sub4 extends StatefulWidget {
  const CSESem3Sub4 ({Key? key, required this.title}) : super(key: key);
  final String title;
  @override
  State<CSESem3Sub4> createState() => _CSESem3Sub4();
}

class _CSESem3Sub4 extends State<CSESem3Sub4> {
  bool semester = false;
  @override
                ...
                child: Card(
                    ...
                    child: InkWell(
                        onLongPress: () => {
                          Navigator.push(
                            context,
                            MaterialPageRoute(builder: (context) =>  const CSESem3Sub4Curr()),
                          )
                        },
                        child: Container(
                ...
                child: Card(
                    ...
                    child: InkWell(
                        onLongPress: () => {
                          Navigator.push(
                            context,
                            MaterialPageRoute(builder: (context) =>  const CSESem3Sub4ebooks()),
                          )
                        },
                        child: Container(
                            decoration: const BoxDecoration(
                    ...
                    child: InkWell(
                        onLongPress: () => {
                          Navigator.push(
                            ...
                            MaterialPageRoute(
                                builder: (context) =>
                                const CSESem3Sub4Utube(title: 'web',)),
                          )
                        },
                        child: Container(
                            decoration: const BoxDecoration(
                ...
                child: Card(
                    ...
                    child: InkWell(
                        onLongPress: () => {
                          Navigator.push(
                            context,
                            MaterialPageRoute(builder: (context) =>  const CSESem3Sub4QTPaper()),
                          )
                        },
                        child: Container(
                            decoration: const BoxDecoration(
                ...
                child: Card(
                    ...
                    child: InkWell(
                        onLongPress: () => {
                          Navigator.push(
                            context,
                            MaterialPageRoute(builder: (context) =>  const CSESem3Sub4QTPaperFormat()),
                          )
                        },
                        child: Container(
                            decoration: const BoxDecoration(
                ...
                child: Card(
                    ...
                    child: InkWell(
                        onLongPress: () => {
                          Navigator.push(
                            context,
                            MaterialPageRoute(builder: (context) =>  const CSESem3Sub4SPrac()),
                          )
                        },
                        child: Container(
                            decoration: const BoxDecoration(
