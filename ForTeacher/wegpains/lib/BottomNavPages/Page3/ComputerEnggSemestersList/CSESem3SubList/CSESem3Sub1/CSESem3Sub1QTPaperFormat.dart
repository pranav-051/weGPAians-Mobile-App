...
class CSESem3Sub1QTPaperFormat extends StatefulWidget{
  const CSESem3Sub1QTPaperFormat({Key?key}) : super(key : key);
  @override
  _CSESem3Sub1QTPaperFormat createState() => _CSESem3Sub1QTPaperFormat();
}

class _CSESem3Sub1QTPaperFormat extends State<CSESem3Sub1QTPaperFormat>{
  //++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
  ...
  uploadDataToFirebase() async{
    ...
    //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    var CSESem3Sub1QTPaperFormat = pick.readAsBytesSync();
    //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    ...
    //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    UploadTask task = pdffile.putData(CSESem3Sub1QTPaperFormat);
    //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    ...
    //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    await FirebaseFirestore.instance.collection("CSESem3Sub1QTPaperFormat").doc().set({
      //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
  ...
  Widget build (BuildContext context) {
    return Scaffold(
      ...
      body: StreamBuilder(
        ...
        //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
        stream: FirebaseFirestore.instance.collection("CSESem3Sub1QTPaperFormat").snapshots(),
        //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
