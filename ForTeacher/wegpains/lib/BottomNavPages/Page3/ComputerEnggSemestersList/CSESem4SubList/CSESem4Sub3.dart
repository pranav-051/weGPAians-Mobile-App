...
import 'CSESem4Sub3/CSESem4Sub3Curr.dart';
import 'CSESem4Sub3/CSESem4Sub3MP.dart';
import 'CSESem4Sub3/CSESem4Sub3QTPaper.dart';
import 'CSESem4Sub3/CSESem4Sub3QTPaperFormat.dart';
import 'CSESem4Sub3/CSESem4Sub3SPrac.dart';
import 'CSESem4Sub3/CSESem4Sub3Utube.dart';
import 'CSESem4Sub3/CSESem4Sub3ebooks.dart';



class CSESem4Sub3 extends StatefulWidget {
  const CSESem4Sub3 ({Key? key, required this.title}) : super(key: key);
  final String title;
  @override
  State<CSESem4Sub3> createState() => _CSESem4Sub3();
}

class _CSESem4Sub3 extends State<CSESem4Sub3> {
  bool semester = false;
  @override
                ...
                child: Card(
                    ...
                    child: InkWell(
                        onLongPress: () => {
                          Navigator.push(
                            context,
                            MaterialPageRoute(builder: (context) =>  const CSESem4Sub3Curr()),
                          )
                        },
                        child: Container(
                ...
                child: Card(
                    ...
                    child: InkWell(
                        onLongPress: () => {
                          Navigator.push(
                            context,
                            MaterialPageRoute(builder: (context) =>  const CSESem4Sub3ebooks()),
                          )
                        },
                        child: Container(
                            decoration: const BoxDecoration(
                    ...
                    child: InkWell(
                        onLongPress: () => {
                          Navigator.push(
                            ...
                            MaterialPageRoute(
                                builder: (context) =>
                                const CSESem4Sub3Utube(title: 'web',)),
                          )
                        },
                        child: Container(
                            decoration: const BoxDecoration(
                ...
                child: Card(
                    ...
                    child: InkWell(
                        onLongPress: () => {
                          Navigator.push(
                            context,
                            MaterialPageRoute(builder: (context) =>  const CSESem4Sub3QTPaper()),
                          )
                        },
                        child: Container(
                            decoration: const BoxDecoration(
                ...
                child: Card(
                    ...
                    child: InkWell(
                        onLongPress: () => {
                          Navigator.push(
                            context,
                            MaterialPageRoute(builder: (context) =>  const CSESem4Sub3QTPaperFormat()),
                          )
                        },
                        child: Container(
                            decoration: const BoxDecoration(
                ...
                child: Card(
                    ...
                    child: InkWell(
                        onLongPress: () => {
                          Navigator.push(
                            context,
                            MaterialPageRoute(builder: (context) =>  const CSESem4Sub3SPrac()),
                          )
                        },
                        child: Container(
                            decoration: const BoxDecoration(
