...
class ITSem2Sub4 extends StatefulWidget {
  const ITSem2Sub4({key, required this.title});
  final String title;
  @override
  State<ITSem2Sub4> createState() => _ITSem2Sub4();
}

class _ITSem2Sub4 extends State<ITSem2Sub4> {
  bool semester = false;
  @override
