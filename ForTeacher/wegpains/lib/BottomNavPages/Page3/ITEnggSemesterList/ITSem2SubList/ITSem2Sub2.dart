...
class ITSem2Sub2 extends StatefulWidget {
  const ITSem2Sub2({key, required this.title});
  final String title;
  @override
  State<ITSem2Sub2> createState() => _ITSem2Sub2();
}

class _ITSem2Sub2 extends State<ITSem2Sub2> {
  bool semester = false;
  @override
