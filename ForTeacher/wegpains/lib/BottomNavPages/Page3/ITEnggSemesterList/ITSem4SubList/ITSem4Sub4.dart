...
class ITSem4Sub4 extends StatefulWidget {
  const ITSem4Sub4({key, required this.title});
  final String title;
  @override
  State<ITSem4Sub4> createState() => _ITSem4Sub4();
}

class _ITSem4Sub4 extends State<ITSem4Sub4> {
  bool semester = false;
  @override
