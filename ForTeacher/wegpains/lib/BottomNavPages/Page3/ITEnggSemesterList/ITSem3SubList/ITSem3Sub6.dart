...
class ITSem3Sub6 extends StatefulWidget {
  const ITSem3Sub6({key, required this.title});
  final String title;
  @override
  State<ITSem3Sub6> createState() => _ITSem3Sub6();
}

class _ITSem3Sub6 extends State<ITSem3Sub6> {
  bool semester = false;
  @override
