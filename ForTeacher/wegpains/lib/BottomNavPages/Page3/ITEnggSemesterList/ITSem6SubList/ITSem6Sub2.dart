...
class ITSem6Sub2 extends StatefulWidget {
  const ITSem6Sub2({key, required this.title});
  final String title;
  @override
  State<ITSem6Sub2> createState() => _ITSem6Sub2();
}

class _ITSem6Sub2 extends State<ITSem6Sub2> {
  bool semester = false;
  @override
