...
class ITSem6Sub1 extends StatefulWidget {
  const ITSem6Sub1({key, required this.title});
  final String title;
  @override
  State<ITSem6Sub1> createState() => _ITSem6Sub1();
}

class _ITSem6Sub1 extends State<ITSem6Sub1> {
  bool semester = false;
  @override
