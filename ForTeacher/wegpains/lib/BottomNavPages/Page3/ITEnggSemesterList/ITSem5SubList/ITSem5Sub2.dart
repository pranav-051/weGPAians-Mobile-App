...
class ITSem5Sub2 extends StatefulWidget {
  const ITSem5Sub2({key, required this.title});
  final String title;
  @override
  State<ITSem5Sub2> createState() => _ITSem5Sub2();
}

class _ITSem5Sub2 extends State<ITSem5Sub2> {
  bool semester = false;
  @override
