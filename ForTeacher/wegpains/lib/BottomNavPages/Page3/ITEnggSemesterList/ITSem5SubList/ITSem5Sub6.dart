...
class ITSem5Sub6 extends StatefulWidget {
  const ITSem5Sub6({key, required this.title});
  final String title;
  @override
  State<ITSem5Sub6> createState() => _ITSem5Sub6();
}

class _ITSem5Sub6 extends State<ITSem5Sub6> {
  bool semester = false;
  @override
