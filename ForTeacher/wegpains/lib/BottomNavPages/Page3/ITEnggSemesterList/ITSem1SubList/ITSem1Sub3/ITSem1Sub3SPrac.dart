...
class ITSem1Sub3SPapers extends StatefulWidget{
  const ITSem1Sub3SPapers({Key?key}) : super(key : key);
  @override
  _ITSem1Sub3SPapers createState() => _ITSem1Sub3SPapers();
}

class _ITSem1Sub3SPapers extends State<ITSem1Sub3SPapers>{
  //++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
  ...
  uploadDataToFirebase() async{
    ...
    //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    var ITSem1Sub3SPapers = pick.readAsBytesSync();
    //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    ...
    //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    UploadTask task = pdffile.putData(ITSem1Sub3SPapers);
    //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    ...
    //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    await FirebaseFirestore.instance.collection("ITSem1Sub3SPapers").doc().set({
      //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
  ...
  Widget build (BuildContext context) {
    return Scaffold(
      ...
      body: StreamBuilder(
        ...
        //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
        stream: FirebaseFirestore.instance.collection("ITSem1Sub3SPapers").snapshots(),
        //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
