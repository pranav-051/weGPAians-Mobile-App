...
class ITSem1Sub2SPrac extends StatefulWidget{
  const ITSem1Sub2SPrac({Key?key}) : super(key : key);
  @override
  _ITSem1Sub2SPrac createState() => _ITSem1Sub2SPrac();
}

class _ITSem1Sub2SPrac extends State<ITSem1Sub2SPrac>{
  //++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
  ...
  uploadDataToFirebase() async{
    ...
    //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    var ITSem1Sub2SPrac = pick.readAsBytesSync();
    //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    ...
    //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    UploadTask task = pdffile.putData(ITSem1Sub2SPrac);
    //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    ...
    //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    await FirebaseFirestore.instance.collection("ITSem1Sub2SPrac").doc().set({
      //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
  ...
  Widget build (BuildContext context) {
    return Scaffold(
      ...
      body: StreamBuilder(
        ...
        //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
        stream: FirebaseFirestore.instance.collection("ITSem1Sub2SPrac").snapshots(),
        //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
