...
class ITSem1Sub2 extends StatefulWidget {
  const ITSem1Sub2({key, required this.title});
  final String title;
  @override
  State<ITSem1Sub2> createState() => _ITSem1Sub2();
}

class _ITSem1Sub2 extends State<ITSem1Sub2> {
  bool semester = false;
  @override
